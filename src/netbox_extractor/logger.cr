module NetboxExtractor
  module Logger
    ...
    def setup_log!
      Log::ShortColorFormat.with_colored_severity(Log::Severity::Info, :cyan)
      Log::ShortColorFormat.with_colored_severity(Log::Severity::Debug, :yellow)
      Log::ShortColorFormat.with_colored_severity(Log::Severity::Warn, :magenta)
    ...
    private def logger
      log_to_stdout? ? Log::IOBackend.new(log_file, formatter: Log::ShortColorFormat) : Log::IOBackend.new(log_file)
    end
