...
module NetboxClient
  ...
  class PowerOutletTemplateRequest
    ...
    def initialize(@name : String, @device_type : ConsolePortTemplateRequestDeviceType? = nil, @module_type : ConsolePortTemplateRequestModuleType? = nil, @label : String? = nil, @_type : String? = nil, @power_port : PatchedWritablePowerOutletTemplateRequestPowerPort? = nil, @feed_leg : String? = nil, @description : String? = nil)
    end
