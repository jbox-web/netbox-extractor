...
module NetboxClient
  ...
  class PatchedWritableInterfaceTemplateRequest
    ...
    def initialize(@device_type : ConsolePortTemplateRequestDeviceType? = nil, @module_type : ConsolePortTemplateRequestModuleType? = nil, @name : String? = nil, @label : String? = nil, @_type : String? = nil, @enabled : Bool? = nil, @mgmt_only : Bool? = nil, @description : String? = nil, @bridge : Int32? = nil, @poe_mode : String? = nil, @poe_type : String? = nil, @rf_role : String? = nil)
    end
