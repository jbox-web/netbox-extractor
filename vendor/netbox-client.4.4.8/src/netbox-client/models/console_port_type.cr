...
module NetboxClient
  class ConsolePortType
    ...
    class EnumAttributeValidatorForLabel < EnumAttributeValidator
      ...
      def initialize
        @attribute = "label"
        @allowable_values = ["DE-9", "DB-25", "RJ-11", "RJ-12", "RJ-45", "Mini-DIN 8", "USB Type A", "USB Type B", "USB Type C", "USB Mini A", "USB Mini B", "USB Micro A", "USB Micro B", "USB Micro AB", "Other"].map { |value| to(String, value) }
      end
    end
