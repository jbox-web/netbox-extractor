...
module NetboxClient
  ...
  class BriefPlatform
    ...
    def initialize(@id : Int32, @url : String, @display : String, @name : String, @slug : String, @device_count : Int32, @virtualmachine_count : Int32, @_depth : Int32, @description : String? = nil)
    end
    ...
    def hash
      [id, url, display, name, slug, description, device_count, virtualmachine_count, _depth].hash
    end
