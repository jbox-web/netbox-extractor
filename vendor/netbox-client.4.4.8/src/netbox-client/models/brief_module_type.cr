...
module NetboxClient
  ...
  class BriefModuleType
    ...
    def initialize(@id : Int32, @url : String, @display : String, @manufacturer : BriefManufacturer, @model : String, @profile : BriefModuleTypeProfile? = nil, @description : String? = nil)
    end
    ...
    def hash
      [id, url, display, profile, manufacturer, model, description].hash
    end
