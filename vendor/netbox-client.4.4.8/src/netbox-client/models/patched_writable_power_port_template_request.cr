...
module NetboxClient
  ...
  class PatchedWritablePowerPortTemplateRequest
    ...
    def initialize(@device_type : ConsolePortTemplateRequestDeviceType? = nil, @module_type : ConsolePortTemplateRequestModuleType? = nil, @name : String? = nil, @label : String? = nil, @_type : String? = nil, @maximum_draw : Int32? = nil, @allocated_draw : Int32? = nil, @description : String? = nil)
    end
