...
module NetboxClient
  ...
  class WritablePowerPortTemplateRequest
    ...
    def initialize(@name : String, @device_type : ConsolePortTemplateRequestDeviceType? = nil, @module_type : ConsolePortTemplateRequestModuleType? = nil, @label : String? = nil, @_type : String? = nil, @maximum_draw : Int32? = nil, @allocated_draw : Int32? = nil, @description : String? = nil)
    end
