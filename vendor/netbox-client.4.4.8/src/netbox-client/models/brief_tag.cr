...
module NetboxClient
  ...
  class BriefTag
    ...
    def initialize(@id : Int32, @url : String, @display : String, @name : String, @slug : String, @color : String? = nil, @description : String? = nil)
    end
    ...
    def hash
      [id, url, display, name, slug, color, description].hash
    end
