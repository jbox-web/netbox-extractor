...
module NetboxClient
  ...
  class PatchedWritablePowerOutletTemplateRequest
    ...
    def initialize(@device_type : ConsolePortTemplateRequestDeviceType? = nil, @module_type : ConsolePortTemplateRequestModuleType? = nil, @name : String? = nil, @label : String? = nil, @_type : String? = nil, @power_port : PatchedWritablePowerOutletTemplateRequestPowerPort? = nil, @feed_leg : String? = nil, @description : String? = nil)
    end
