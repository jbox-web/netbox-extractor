...
module NetboxClient
  class IpamServicesCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(WritableServiceRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritableServiceRequest.class, data)
      return if data.nil?
