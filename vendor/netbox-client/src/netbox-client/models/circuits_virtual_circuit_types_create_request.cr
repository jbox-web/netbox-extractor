...
module NetboxClient
  class CircuitsVirtualCircuitTypesCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(VirtualCircuitTypeRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : VirtualCircuitTypeRequest.class, data)
      return if data.nil?
