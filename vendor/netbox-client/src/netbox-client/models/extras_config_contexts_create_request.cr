...
module NetboxClient
  class ExtrasConfigContextsCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(ConfigContextRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : ConfigContextRequest.class, data)
      return if data.nil?
