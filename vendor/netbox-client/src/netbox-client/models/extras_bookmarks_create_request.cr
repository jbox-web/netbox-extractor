...
module NetboxClient
  class ExtrasBookmarksCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(BookmarkRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : BookmarkRequest.class, data)
      return if data.nil?
