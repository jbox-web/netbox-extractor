...
module NetboxClient
  class DcimDeviceRolesCreateRequest
    ...
    def self.openapi_one_of
      [
        Array(WritableDeviceRoleRequest),
    ...
    private def self.find_and_cast_into_type(klass : Array(WritableDeviceRoleRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritableDeviceRoleRequest.class, data)
      return if data.nil?
