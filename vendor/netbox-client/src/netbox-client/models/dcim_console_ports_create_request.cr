...
module NetboxClient
  class DcimConsolePortsCreateRequest
    ...
    def self.openapi_one_of
      [
        Array(WritableConsolePortRequest),
    ...
    private def self.find_and_cast_into_type(klass : Array(WritableConsolePortRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritableConsolePortRequest.class, data)
      return if data.nil?
