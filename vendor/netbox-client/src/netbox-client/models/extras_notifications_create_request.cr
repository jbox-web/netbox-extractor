...
module NetboxClient
  class ExtrasNotificationsCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(NotificationRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : NotificationRequest.class, data)
      return if data.nil?
