...
module NetboxClient
  class DcimConsoleServerPortsCreateRequest
    ...
    def self.openapi_one_of
      [
        Array(WritableConsoleServerPortRequest),
    ...
    private def self.find_and_cast_into_type(klass : Array(WritableConsoleServerPortRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritableConsoleServerPortRequest.class, data)
      return if data.nil?
