...
module NetboxClient
  class DcimRackReservationsCreateRequest
    ...
    def self.openapi_one_of
      [
        Array(WritableRackReservationRequest),
    ...
    private def self.find_and_cast_into_type(klass : Array(WritableRackReservationRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritableRackReservationRequest.class, data)
      return if data.nil?
