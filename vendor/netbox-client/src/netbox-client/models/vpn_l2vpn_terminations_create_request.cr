...
module NetboxClient
  class VpnL2vpnTerminationsCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(L2VPNTerminationRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : L2VPNTerminationRequest.class, data)
      return if data.nil?
