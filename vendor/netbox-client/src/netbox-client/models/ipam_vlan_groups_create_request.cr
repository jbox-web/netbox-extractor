...
module NetboxClient
  class IpamVlanGroupsCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(VLANGroupRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : VLANGroupRequest.class, data)
      return if data.nil?
