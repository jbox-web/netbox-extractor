...
module NetboxClient
  class IpamIpAddressesCreateRequest
    ...
    def self.openapi_one_of
      [
        Array(WritableIPAddressRequest),
    ...
    private def self.find_and_cast_into_type(klass : Array(WritableIPAddressRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritableIPAddressRequest.class, data)
      return if data.nil?
