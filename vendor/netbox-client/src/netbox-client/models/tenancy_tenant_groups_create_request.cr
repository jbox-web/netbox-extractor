...
module NetboxClient
  class TenancyTenantGroupsCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(WritableTenantGroupRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritableTenantGroupRequest.class, data)
      return if data.nil?
