...
module NetboxClient
  ...
  class WritableInterfaceRequest
    ...
    def list_invalid_properties
      ...
      if (msg = duplex_validation_error(@duplex))
        invalid_properties.push(msg)
      end
      ...
      if (msg = rf_role_validation_error(@rf_role))
        invalid_properties.push(msg)
      end
      if (msg = rf_channel_validation_error(@rf_channel))
        invalid_properties.push(msg)
      end
      if (msg = poe_mode_validation_error(@poe_mode))
        invalid_properties.push(msg)
      end
      if (msg = poe_type_validation_error(@poe_type))
        invalid_properties.push(msg)
      end
    ...
    def_equals_and_hash(device, vdcs, _module, name, label, _type, enabled, parent, bridge, lag, mtu, primary_mac_address, speed, duplex, wwn, mgmt_only, description, mode, rf_role, rf_channel, poe_mode, poe_type, rf_channel_frequency, rf_channel_width, tx_power, untagged_vlan, tagged_vlans, qinq_svlan, vlan_translation_policy, mark_connected, wireless_lans, vrf, tags, custom_fields)
  end
