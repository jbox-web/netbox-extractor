...
module NetboxClient
  class TenancyContactRolesCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(ContactRoleRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : ContactRoleRequest.class, data)
      return if data.nil?
