...
module NetboxClient
  class VpnTunnelsCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(WritableTunnelRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritableTunnelRequest.class, data)
      return if data.nil?
