...
module NetboxClient
  class DcimVirtualChassisCreateRequest
    ...
    def self.openapi_one_of
      [
        Array(WritableVirtualChassisRequest),
    ...
    private def self.find_and_cast_into_type(klass : Array(WritableVirtualChassisRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritableVirtualChassisRequest.class, data)
      return if data.nil?
