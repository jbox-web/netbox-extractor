...
module NetboxClient
  ...
  class BriefClusterGroup
    ...
    @[JSON::Field(key: "cluster_count", type: Int64?, nillable: true, emit_null: false)]
    ...
    def initialize(@id : Int32, @url : String, @display : String, @name : String, @slug : String, @cluster_count : Int64, @description : String? = nil)
    end
