...
module NetboxClient
  class DcimRearPortsCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(WritableRearPortRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritableRearPortRequest.class, data)
      return if data.nil?
