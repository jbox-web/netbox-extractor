...
module NetboxClient
  class DcimSiteGroupsCreateRequest
    ...
    def self.openapi_one_of
      [
        Array(WritableSiteGroupRequest),
    ...
    private def self.find_and_cast_into_type(klass : Array(WritableSiteGroupRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritableSiteGroupRequest.class, data)
      return if data.nil?
