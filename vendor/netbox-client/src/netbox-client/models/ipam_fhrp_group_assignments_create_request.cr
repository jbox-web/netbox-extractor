...
module NetboxClient
  class IpamFhrpGroupAssignmentsCreateRequest
    ...
    def self.openapi_one_of
      [
        Array(FHRPGroupAssignmentRequest),
    ...
    private def self.find_and_cast_into_type(klass : Array(FHRPGroupAssignmentRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : FHRPGroupAssignmentRequest.class, data)
      return if data.nil?
