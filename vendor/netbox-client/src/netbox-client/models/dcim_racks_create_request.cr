...
module NetboxClient
  class DcimRacksCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(WritableRackRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritableRackRequest.class, data)
      return if data.nil?
