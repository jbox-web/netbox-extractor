...
module NetboxClient
  class DcimConsolePortTemplatesCreateRequest
    ...
    def self.openapi_one_of
      [
        Array(WritableConsolePortTemplateRequest),
    ...
    private def self.find_and_cast_into_type(klass : Array(WritableConsolePortTemplateRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritableConsolePortTemplateRequest.class, data)
      return if data.nil?
