...
module NetboxClient
  class DcimVirtualDeviceContextsCreateRequest
    ...
    def self.openapi_one_of
      [
        Array(WritableVirtualDeviceContextRequest),
    ...
    private def self.find_and_cast_into_type(klass : Array(WritableVirtualDeviceContextRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritableVirtualDeviceContextRequest.class, data)
      return if data.nil?
