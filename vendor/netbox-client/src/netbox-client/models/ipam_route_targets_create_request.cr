...
module NetboxClient
  class IpamRouteTargetsCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(RouteTargetRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : RouteTargetRequest.class, data)
      return if data.nil?
