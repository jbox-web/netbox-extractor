...
module NetboxClient
  class CircuitsCircuitTypesCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(CircuitTypeRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : CircuitTypeRequest.class, data)
      return if data.nil?
