...
module NetboxClient
  class WirelessWirelessLinksCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(WritableWirelessLinkRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritableWirelessLinkRequest.class, data)
      return if data.nil?
