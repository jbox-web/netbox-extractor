...
module NetboxClient
  class VpnIkeProposalsCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(WritableIKEProposalRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritableIKEProposalRequest.class, data)
      return if data.nil?
