...
module NetboxClient
  class IpamIpRangesCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(WritableIPRangeRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritableIPRangeRequest.class, data)
      return if data.nil?
