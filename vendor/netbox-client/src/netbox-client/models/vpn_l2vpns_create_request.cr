...
module NetboxClient
  class VpnL2vpnsCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(WritableL2VPNRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritableL2VPNRequest.class, data)
      return if data.nil?
