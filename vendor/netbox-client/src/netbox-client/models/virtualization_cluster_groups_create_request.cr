...
module NetboxClient
  class VirtualizationClusterGroupsCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(ClusterGroupRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : ClusterGroupRequest.class, data)
      return if data.nil?
