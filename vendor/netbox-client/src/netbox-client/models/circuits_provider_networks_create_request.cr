...
module NetboxClient
  class CircuitsProviderNetworksCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(ProviderNetworkRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : ProviderNetworkRequest.class, data)
      return if data.nil?
