...
module NetboxClient
  class UsersPermissionsCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(ObjectPermissionRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : ObjectPermissionRequest.class, data)
      return if data.nil?
