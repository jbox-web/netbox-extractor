...
module NetboxClient
  class VirtualizationInterfacesCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(WritableVMInterfaceRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritableVMInterfaceRequest.class, data)
      return if data.nil?
