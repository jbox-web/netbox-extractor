...
module NetboxClient
  class ExtrasImageAttachmentsCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(ImageAttachmentRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : ImageAttachmentRequest.class, data)
      return if data.nil?
