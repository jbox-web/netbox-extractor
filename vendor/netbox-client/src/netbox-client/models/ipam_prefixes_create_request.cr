...
module NetboxClient
  class IpamPrefixesCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(WritablePrefixRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritablePrefixRequest.class, data)
      return if data.nil?
