...
module NetboxClient
  class ExtrasSubscriptionsCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(SubscriptionRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : SubscriptionRequest.class, data)
      return if data.nil?
