...
module NetboxClient
  class VirtualizationVirtualDisksCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(VirtualDiskRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : VirtualDiskRequest.class, data)
      return if data.nil?
