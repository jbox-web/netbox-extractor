...
module NetboxClient
  class DcimRackRolesCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(RackRoleRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : RackRoleRequest.class, data)
      return if data.nil?
