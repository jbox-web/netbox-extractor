...
module NetboxClient
  class IpamVlanTranslationRulesCreateRequest
    ...
    def self.openapi_one_of
      [
        Array(VLANTranslationRuleRequest),
    ...
    private def self.find_and_cast_into_type(klass : Array(VLANTranslationRuleRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : VLANTranslationRuleRequest.class, data)
      return if data.nil?
