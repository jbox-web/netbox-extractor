...
module NetboxClient
  class ExtrasCustomFieldsCreateRequest
    ...
    def self.openapi_one_of
      [
        Array(WritableCustomFieldRequest),
    ...
    private def self.find_and_cast_into_type(klass : Array(WritableCustomFieldRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritableCustomFieldRequest.class, data)
      return if data.nil?
