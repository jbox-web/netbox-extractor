...
module NetboxClient
  class TenancyContactAssignmentsCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(WritableContactAssignmentRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritableContactAssignmentRequest.class, data)
      return if data.nil?
