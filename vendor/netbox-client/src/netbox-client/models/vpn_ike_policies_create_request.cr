...
module NetboxClient
  class VpnIkePoliciesCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(WritableIKEPolicyRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritableIKEPolicyRequest.class, data)
      return if data.nil?
