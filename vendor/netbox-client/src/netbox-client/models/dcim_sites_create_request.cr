...
module NetboxClient
  class DcimSitesCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(WritableSiteRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritableSiteRequest.class, data)
      return if data.nil?
