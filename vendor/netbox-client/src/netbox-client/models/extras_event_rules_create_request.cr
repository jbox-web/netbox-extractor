...
module NetboxClient
  class ExtrasEventRulesCreateRequest
    ...
    def self.openapi_one_of
      [
        Array(WritableEventRuleRequest),
    ...
    private def self.find_and_cast_into_type(klass : Array(WritableEventRuleRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritableEventRuleRequest.class, data)
      return if data.nil?
