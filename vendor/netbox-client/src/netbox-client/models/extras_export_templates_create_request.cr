...
module NetboxClient
  class ExtrasExportTemplatesCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(ExportTemplateRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : ExportTemplateRequest.class, data)
      return if data.nil?
