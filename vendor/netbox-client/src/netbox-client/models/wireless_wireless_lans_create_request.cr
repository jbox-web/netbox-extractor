...
module NetboxClient
  class WirelessWirelessLansCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(WritableWirelessLANRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritableWirelessLANRequest.class, data)
      return if data.nil?
