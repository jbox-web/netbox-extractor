...
module NetboxClient
  class DcimManufacturersCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(ManufacturerRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : ManufacturerRequest.class, data)
      return if data.nil?
