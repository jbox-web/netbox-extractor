...
module NetboxClient
  class VpnIpsecProposalsCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(WritableIPSecProposalRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritableIPSecProposalRequest.class, data)
      return if data.nil?
