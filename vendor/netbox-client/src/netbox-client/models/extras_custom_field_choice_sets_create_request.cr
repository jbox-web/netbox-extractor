...
module NetboxClient
  class ExtrasCustomFieldChoiceSetsCreateRequest
    ...
    def self.openapi_one_of
      [
        Array(WritableCustomFieldChoiceSetRequest),
    ...
    private def self.find_and_cast_into_type(klass : Array(WritableCustomFieldChoiceSetRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritableCustomFieldChoiceSetRequest.class, data)
      return if data.nil?
