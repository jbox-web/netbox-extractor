...
module NetboxClient
  class CircuitsProviderAccountsCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(ProviderAccountRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : ProviderAccountRequest.class, data)
      return if data.nil?
