...
module NetboxClient
  class ExtrasJournalEntriesCreateRequest
    ...
    def self.openapi_one_of
      [
        Array(WritableJournalEntryRequest),
    ...
    private def self.find_and_cast_into_type(klass : Array(WritableJournalEntryRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritableJournalEntryRequest.class, data)
      return if data.nil?
