...
module NetboxClient
  ...
  class ConfigContextProfileRequest
    ...
    def initialize(@name : String, @description : String? = nil, @schema : JSON::Any? = nil, @tags : Array(String)? = nil, @comments : String? = nil, @data_source : ConfigContextProfileRequestDataSource? = nil)
    end
