...
module NetboxClient
  class DcimPowerPanelsCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(PowerPanelRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : PowerPanelRequest.class, data)
      return if data.nil?
