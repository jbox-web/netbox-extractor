...
module NetboxClient
  class ExtrasConfigContextProfilesCreateRequest
    ...
    def self.openapi_one_of
      [
        Array(ConfigContextProfileRequest),
    ...
    private def self.find_and_cast_into_type(klass : Array(ConfigContextProfileRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : ConfigContextProfileRequest.class, data)
      return if data.nil?
