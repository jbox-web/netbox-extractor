...
module NetboxClient
  class DcimInventoryItemTemplatesCreateRequest
    ...
    def self.openapi_one_of
      [
        Array(InventoryItemTemplateRequest),
    ...
    private def self.find_and_cast_into_type(klass : Array(InventoryItemTemplateRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : InventoryItemTemplateRequest.class, data)
      return if data.nil?
