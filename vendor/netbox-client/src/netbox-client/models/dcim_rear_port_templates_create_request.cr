...
module NetboxClient
  class DcimRearPortTemplatesCreateRequest
    ...
    def self.openapi_one_of
      [
        Array(WritableRearPortTemplateRequest),
    ...
    private def self.find_and_cast_into_type(klass : Array(WritableRearPortTemplateRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritableRearPortTemplateRequest.class, data)
      return if data.nil?
