...
module NetboxClient
  class VpnIpsecProfilesCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(WritableIPSecProfileRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritableIPSecProfileRequest.class, data)
      return if data.nil?
