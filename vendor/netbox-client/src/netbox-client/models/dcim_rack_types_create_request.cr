...
module NetboxClient
  class DcimRackTypesCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(WritableRackTypeRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritableRackTypeRequest.class, data)
      return if data.nil?
