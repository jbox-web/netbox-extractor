...
module NetboxClient
  class CircuitsCircuitsCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(WritableCircuitRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritableCircuitRequest.class, data)
      return if data.nil?
