...
module NetboxClient
  class DcimRegionsCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(WritableRegionRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritableRegionRequest.class, data)
      return if data.nil?
