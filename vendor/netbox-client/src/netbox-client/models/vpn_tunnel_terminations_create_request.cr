...
module NetboxClient
  class VpnTunnelTerminationsCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(WritableTunnelTerminationRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritableTunnelTerminationRequest.class, data)
      return if data.nil?
