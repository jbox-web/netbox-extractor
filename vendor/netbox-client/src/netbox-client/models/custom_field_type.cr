...
module NetboxClient
  class CustomFieldType
    ...
    class EnumAttributeValidatorForLabel < EnumAttributeValidator
      ...
      def initialize
        @attribute = "label"
        @allowable_values = ["Text", "Text (long)", "Integer", "Decimal", "Boolean (true/false)", "Date", "Date & time", "URL", "JSON", "Selection", "Multiple selection", "Object", "Multiple objects"].map { |value| to(String, value) }
      end
    end
