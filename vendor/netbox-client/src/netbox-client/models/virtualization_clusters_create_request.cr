...
module NetboxClient
  class VirtualizationClustersCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(WritableClusterRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritableClusterRequest.class, data)
      return if data.nil?
