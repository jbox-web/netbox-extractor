...
module NetboxClient
  class ExtrasWebhooksCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(WebhookRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WebhookRequest.class, data)
      return if data.nil?
