...
module NetboxClient
  class DcimFrontPortTemplatesCreateRequest
    ...
    def self.openapi_one_of
      [
        Array(WritableFrontPortTemplateRequest),
    ...
    private def self.find_and_cast_into_type(klass : Array(WritableFrontPortTemplateRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritableFrontPortTemplateRequest.class, data)
      return if data.nil?
