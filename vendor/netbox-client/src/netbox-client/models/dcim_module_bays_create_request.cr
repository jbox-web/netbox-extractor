...
module NetboxClient
  class DcimModuleBaysCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(ModuleBayRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : ModuleBayRequest.class, data)
      return if data.nil?
