...
module NetboxClient
  class DcimPowerPortsCreateRequest
    ...
    def self.openapi_one_of
      [
        Array(WritablePowerPortRequest),
    ...
    private def self.find_and_cast_into_type(klass : Array(WritablePowerPortRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritablePowerPortRequest.class, data)
      return if data.nil?
