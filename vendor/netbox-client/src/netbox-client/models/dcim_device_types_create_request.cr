...
module NetboxClient
  class DcimDeviceTypesCreateRequest
    ...
    def self.openapi_one_of
      [
        Array(WritableDeviceTypeRequest),
    ...
    private def self.find_and_cast_into_type(klass : Array(WritableDeviceTypeRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritableDeviceTypeRequest.class, data)
      return if data.nil?
