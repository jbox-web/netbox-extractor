...
module NetboxClient
  class DcimInterfaceTemplatesCreateRequest
    ...
    def self.openapi_one_of
      [
        Array(WritableInterfaceTemplateRequest),
    ...
    private def self.find_and_cast_into_type(klass : Array(WritableInterfaceTemplateRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritableInterfaceTemplateRequest.class, data)
      return if data.nil?
