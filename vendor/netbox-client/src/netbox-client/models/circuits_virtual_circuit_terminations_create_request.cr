...
module NetboxClient
  class CircuitsVirtualCircuitTerminationsCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(WritableVirtualCircuitTerminationRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritableVirtualCircuitTerminationRequest.class, data)
      return if data.nil?
