...
module NetboxClient
  class IpamFhrpGroupsCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(FHRPGroupRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : FHRPGroupRequest.class, data)
      return if data.nil?
