...
module NetboxClient
  class DcimModuleTypesCreateRequest
    ...
    def self.openapi_one_of
      [
        Array(WritableModuleTypeRequest),
    ...
    private def self.find_and_cast_into_type(klass : Array(WritableModuleTypeRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritableModuleTypeRequest.class, data)
      return if data.nil?
