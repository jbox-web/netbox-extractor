...
module NetboxClient
  class DcimPowerOutletTemplatesCreateRequest
    ...
    def self.openapi_one_of
      [
        Array(WritablePowerOutletTemplateRequest),
    ...
    private def self.find_and_cast_into_type(klass : Array(WritablePowerOutletTemplateRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritablePowerOutletTemplateRequest.class, data)
      return if data.nil?
