...
module NetboxClient
  class DcimFrontPortsCreateRequest
    ...
    def self.openapi_one_of
      [
        Array(WritableFrontPortRequest),
    ...
    private def self.find_and_cast_into_type(klass : Array(WritableFrontPortRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritableFrontPortRequest.class, data)
      return if data.nil?
