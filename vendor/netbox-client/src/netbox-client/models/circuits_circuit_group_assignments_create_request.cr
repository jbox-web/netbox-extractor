...
module NetboxClient
  class CircuitsCircuitGroupAssignmentsCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(WritableCircuitGroupAssignmentRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritableCircuitGroupAssignmentRequest.class, data)
      return if data.nil?
