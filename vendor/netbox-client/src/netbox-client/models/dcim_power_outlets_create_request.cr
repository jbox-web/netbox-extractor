...
module NetboxClient
  class DcimPowerOutletsCreateRequest
    ...
    def self.openapi_one_of
      [
        Array(WritablePowerOutletRequest),
    ...
    private def self.find_and_cast_into_type(klass : Array(WritablePowerOutletRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritablePowerOutletRequest.class, data)
      return if data.nil?
