...
module NetboxClient
  class DcimModulesCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(WritableModuleRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritableModuleRequest.class, data)
      return if data.nil?
