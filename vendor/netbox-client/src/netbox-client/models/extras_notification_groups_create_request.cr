...
module NetboxClient
  class ExtrasNotificationGroupsCreateRequest
    ...
    def self.openapi_one_of
      [
        Array(NotificationGroupRequest),
    ...
    private def self.find_and_cast_into_type(klass : Array(NotificationGroupRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : NotificationGroupRequest.class, data)
      return if data.nil?
