...
module NetboxClient
  class VirtualizationClusterTypesCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(ClusterTypeRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : ClusterTypeRequest.class, data)
      return if data.nil?
