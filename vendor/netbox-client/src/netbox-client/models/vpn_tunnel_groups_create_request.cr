...
module NetboxClient
  class VpnTunnelGroupsCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(TunnelGroupRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : TunnelGroupRequest.class, data)
      return if data.nil?
