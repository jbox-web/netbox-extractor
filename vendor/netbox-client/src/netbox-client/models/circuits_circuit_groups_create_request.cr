...
module NetboxClient
  class CircuitsCircuitGroupsCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(CircuitGroupRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : CircuitGroupRequest.class, data)
      return if data.nil?
