...
module NetboxClient
  class IpamVlanTranslationPoliciesCreateRequest
    ...
    def self.openapi_one_of
      [
        Array(VLANTranslationPolicyRequest),
    ...
    private def self.find_and_cast_into_type(klass : Array(VLANTranslationPolicyRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : VLANTranslationPolicyRequest.class, data)
      return if data.nil?
