...
module NetboxClient
  class IpamServiceTemplatesCreateRequest
    ...
    def self.openapi_one_of
      [
        Array(WritableServiceTemplateRequest),
    ...
    private def self.find_and_cast_into_type(klass : Array(WritableServiceTemplateRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritableServiceTemplateRequest.class, data)
      return if data.nil?
