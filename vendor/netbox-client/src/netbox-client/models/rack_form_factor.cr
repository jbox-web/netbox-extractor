...
module NetboxClient
  class RackFormFactor
    ...
    class EnumAttributeValidatorForLabel < EnumAttributeValidator
      ...
      def initialize
        @attribute = "label"
        @allowable_values = ["2-post frame", "4-post frame", "4-post cabinet", "Wall-mounted frame", "Wall-mounted frame (vertical)", "Wall-mounted cabinet", "Wall-mounted cabinet (vertical)"].map { |value| to(String, value) }
      end
    end
