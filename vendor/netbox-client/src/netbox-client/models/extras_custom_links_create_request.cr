...
module NetboxClient
  class ExtrasCustomLinksCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(CustomLinkRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : CustomLinkRequest.class, data)
      return if data.nil?
