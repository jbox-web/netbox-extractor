...
module NetboxClient
  class DcimLocationsCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(WritableLocationRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritableLocationRequest.class, data)
      return if data.nil?
