...
module NetboxClient
  class DcimInventoryItemsCreateRequest
    ...
    def self.openapi_one_of
      [
        Array(WritableInventoryItemRequest),
    ...
    private def self.find_and_cast_into_type(klass : Array(WritableInventoryItemRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritableInventoryItemRequest.class, data)
      return if data.nil?
