...
module NetboxClient
  class ExtrasSavedFiltersCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(SavedFilterRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : SavedFilterRequest.class, data)
      return if data.nil?
