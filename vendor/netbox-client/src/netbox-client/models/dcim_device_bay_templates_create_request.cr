...
module NetboxClient
  class DcimDeviceBayTemplatesCreateRequest
    ...
    def self.openapi_one_of
      [
        Array(DeviceBayTemplateRequest),
    ...
    private def self.find_and_cast_into_type(klass : Array(DeviceBayTemplateRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : DeviceBayTemplateRequest.class, data)
      return if data.nil?
