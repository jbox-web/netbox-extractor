...
module NetboxClient
  class DcimPowerPortTemplatesCreateRequest
    ...
    def self.openapi_one_of
      [
        Array(WritablePowerPortTemplateRequest),
    ...
    private def self.find_and_cast_into_type(klass : Array(WritablePowerPortTemplateRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritablePowerPortTemplateRequest.class, data)
      return if data.nil?
