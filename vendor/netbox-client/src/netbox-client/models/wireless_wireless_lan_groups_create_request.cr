...
module NetboxClient
  class WirelessWirelessLanGroupsCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(WritableWirelessLANGroupRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritableWirelessLANGroupRequest.class, data)
      return if data.nil?
