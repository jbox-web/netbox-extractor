...
module NetboxClient
  class IpamAsnRangesCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : ASNRangeRequest.class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : Array(ASNRangeRequest).class, data)
      return if data.nil?
