...
module NetboxClient
  class DcimPlatformsCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(WritablePlatformRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritablePlatformRequest.class, data)
      return if data.nil?
