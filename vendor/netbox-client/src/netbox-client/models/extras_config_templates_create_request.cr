...
module NetboxClient
  class ExtrasConfigTemplatesCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(ConfigTemplateRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : ConfigTemplateRequest.class, data)
      return if data.nil?
