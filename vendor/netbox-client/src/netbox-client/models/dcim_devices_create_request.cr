...
module NetboxClient
  class DcimDevicesCreateRequest
    ...
    def self.openapi_one_of
      [
        Array(WritableDeviceWithConfigContextRequest),
    ...
    private def self.find_and_cast_into_type(klass : Array(WritableDeviceWithConfigContextRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritableDeviceWithConfigContextRequest.class, data)
      return if data.nil?
