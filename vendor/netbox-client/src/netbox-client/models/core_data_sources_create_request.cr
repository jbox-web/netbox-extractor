...
module NetboxClient
  class CoreDataSourcesCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(WritableDataSourceRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritableDataSourceRequest.class, data)
      return if data.nil?
