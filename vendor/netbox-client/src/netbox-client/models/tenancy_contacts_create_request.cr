...
module NetboxClient
  class TenancyContactsCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(ContactRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : ContactRequest.class, data)
      return if data.nil?
