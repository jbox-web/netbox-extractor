...
module NetboxClient
  class IpamAggregatesCreateRequest
    ...
    def self.openapi_one_of
      [
        Array(WritableAggregateRequest),
    ...
    private def self.find_and_cast_into_type(klass : Array(WritableAggregateRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritableAggregateRequest.class, data)
      return if data.nil?
