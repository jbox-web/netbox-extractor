...
module NetboxClient
  ...
  class BriefRIR
    ...
    @[JSON::Field(key: "aggregate_count", type: Int64?, nillable: true, emit_null: false)]
    ...
    def initialize(@id : Int32, @url : String, @display : String, @name : String, @slug : String, @aggregate_count : Int64, @description : String? = nil)
    end
