...
module NetboxClient
  class CircuitsProvidersCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(ProviderRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : ProviderRequest.class, data)
      return if data.nil?
