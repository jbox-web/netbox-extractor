...
module NetboxClient
  class DcimModuleBayTemplatesCreateRequest
    ...
    def self.openapi_one_of
      [
        Array(ModuleBayTemplateRequest),
    ...
    private def self.find_and_cast_into_type(klass : Array(ModuleBayTemplateRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : ModuleBayTemplateRequest.class, data)
      return if data.nil?
