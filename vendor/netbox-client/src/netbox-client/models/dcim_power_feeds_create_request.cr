...
module NetboxClient
  class DcimPowerFeedsCreateRequest
    ...
    def self.openapi_one_of
      [
        Array(WritablePowerFeedRequest),
    ...
    private def self.find_and_cast_into_type(klass : Array(WritablePowerFeedRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritablePowerFeedRequest.class, data)
      return if data.nil?
