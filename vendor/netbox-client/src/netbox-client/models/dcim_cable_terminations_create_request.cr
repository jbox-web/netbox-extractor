...
module NetboxClient
  class DcimCableTerminationsCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(CableTerminationRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : CableTerminationRequest.class, data)
      return if data.nil?
