...
module NetboxClient
  class CircuitsVirtualCircuitsCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(WritableVirtualCircuitRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritableVirtualCircuitRequest.class, data)
      return if data.nil?
