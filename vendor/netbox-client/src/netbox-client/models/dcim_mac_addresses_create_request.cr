...
module NetboxClient
  class DcimMacAddressesCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(MACAddressRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : MACAddressRequest.class, data)
      return if data.nil?
