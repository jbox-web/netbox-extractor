...
module NetboxClient
  class DcimInterfacesCreateRequest
    ...
    def self.openapi_one_of
      [
        Array(WritableInterfaceRequest),
    ...
    private def self.find_and_cast_into_type(klass : Array(WritableInterfaceRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritableInterfaceRequest.class, data)
      return if data.nil?
