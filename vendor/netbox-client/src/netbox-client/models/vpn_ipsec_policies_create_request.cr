...
module NetboxClient
  class VpnIpsecPoliciesCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(WritableIPSecPolicyRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritableIPSecPolicyRequest.class, data)
      return if data.nil?
