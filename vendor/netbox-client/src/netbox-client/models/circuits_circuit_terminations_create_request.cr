...
module NetboxClient
  class CircuitsCircuitTerminationsCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(CircuitTerminationRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : CircuitTerminationRequest.class, data)
      return if data.nil?
