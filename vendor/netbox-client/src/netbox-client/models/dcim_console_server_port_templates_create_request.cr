...
module NetboxClient
  class DcimConsoleServerPortTemplatesCreateRequest
    ...
    def self.openapi_one_of
      [
        Array(WritableConsoleServerPortTemplateRequest),
    ...
    private def self.find_and_cast_into_type(klass : Array(WritableConsoleServerPortTemplateRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritableConsoleServerPortTemplateRequest.class, data)
      return if data.nil?
