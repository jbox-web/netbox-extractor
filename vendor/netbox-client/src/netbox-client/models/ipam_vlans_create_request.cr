...
module NetboxClient
  class IpamVlansCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(WritableVLANRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritableVLANRequest.class, data)
      return if data.nil?
