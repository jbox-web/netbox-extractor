...
module NetboxClient
  class DcimInventoryItemRolesCreateRequest
    ...
    def self.openapi_one_of
      [
        Array(InventoryItemRoleRequest),
    ...
    private def self.find_and_cast_into_type(klass : Array(InventoryItemRoleRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : InventoryItemRoleRequest.class, data)
      return if data.nil?
