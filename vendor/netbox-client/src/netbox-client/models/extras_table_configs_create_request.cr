...
module NetboxClient
  class ExtrasTableConfigsCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(TableConfigRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : TableConfigRequest.class, data)
      return if data.nil?
