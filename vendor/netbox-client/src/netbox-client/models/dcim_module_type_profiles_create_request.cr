...
module NetboxClient
  class DcimModuleTypeProfilesCreateRequest
    ...
    def self.openapi_one_of
      [
        Array(ModuleTypeProfileRequest),
    ...
    private def self.find_and_cast_into_type(klass : Array(ModuleTypeProfileRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : ModuleTypeProfileRequest.class, data)
      return if data.nil?
