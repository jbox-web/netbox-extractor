...
module NetboxClient
  class TenancyContactGroupsCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(WritableContactGroupRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritableContactGroupRequest.class, data)
      return if data.nil?
