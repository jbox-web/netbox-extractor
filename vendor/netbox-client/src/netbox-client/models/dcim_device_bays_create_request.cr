...
module NetboxClient
  class DcimDeviceBaysCreateRequest
    ...
    private def self.find_and_cast_into_type(klass : Array(DeviceBayRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : DeviceBayRequest.class, data)
      return if data.nil?
