...
module NetboxClient
  class VirtualizationVirtualMachinesCreateRequest
    ...
    def self.openapi_one_of
      [
        Array(WritableVirtualMachineWithConfigContextRequest),
    ...
    private def self.find_and_cast_into_type(klass : Array(WritableVirtualMachineWithConfigContextRequest).class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : WritableVirtualMachineWithConfigContextRequest.class, data)
      return if data.nil?
