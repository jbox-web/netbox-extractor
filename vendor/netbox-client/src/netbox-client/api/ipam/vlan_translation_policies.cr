...
module NetboxClient
  module Api
  class Ipam::VlanTranslationPolicies
    def initialize(@conn : Connection); end

    #  Delete a list of VLAN translation policy objects.
    def bulk_destroy(vlan_translation_policy_request : Array(NetboxClient::VLANTranslationPolicyRequest)) : Response(Nil)
      @conn.request(Nil,
        method: :DELETE,
        path: "/api/ipam/vlan-translation-policies/",
        body: vlan_translation_policy_request,
        accept: %w[],
    ...
    def bulk_partial_update(vlan_translation_policy_request : Array(NetboxClient::VLANTranslationPolicyRequest)) : Response(Array(NetboxClient::VLANTranslationPolicy))
      @conn.request(Array(NetboxClient::VLANTranslationPolicy),
        method: :PATCH,
        path: "/api/ipam/vlan-translation-policies/",
        body: vlan_translation_policy_request,
    ...
    def bulk_update(vlan_translation_policy_request : Array(NetboxClient::VLANTranslationPolicyRequest)) : Response(Array(NetboxClient::VLANTranslationPolicy))
      @conn.request(Array(NetboxClient::VLANTranslationPolicy),
        method: :PUT,
        path: "/api/ipam/vlan-translation-policies/",
        body: vlan_translation_policy_request,
    ...
    def create(ipam_vlan_translation_policies_create_request : NetboxClient::IpamVlanTranslationPoliciesCreateRequest) : Response(NetboxClient::VLANTranslationPolicy)
      @conn.request(NetboxClient::VLANTranslationPolicy,
        method: :POST,
        path: "/api/ipam/vlan-translation-policies/",
        body: ipam_vlan_translation_policies_create_request,
        accept: %w[application/json],
        content_type: %w[application/json multipart/form-data],
        auth: %w[cookieAuth tokenAuth])
    end
    ...
    def partial_update(id : Int32, patched_vlan_translation_policy_request : NetboxClient::PatchedVLANTranslationPolicyRequest? = nil) : Response(NetboxClient::VLANTranslationPolicy)
      @conn.request(NetboxClient::VLANTranslationPolicy,
        method: :PATCH,
        path: "/api/ipam/vlan-translation-policies/{id}/".sub("{id}", NetboxClient.enc(id)),
        body: patched_vlan_translation_policy_request,
        accept: %w[application/json],
        content_type: %w[application/json multipart/form-data],
        auth: %w[cookieAuth tokenAuth])
    end
    ...
    def retrieve(id : Int32) : Response(NetboxClient::VLANTranslationPolicy)
      @conn.request(NetboxClient::VLANTranslationPolicy,
        method: :GET,
        path: "/api/ipam/vlan-translation-policies/{id}/".sub("{id}", NetboxClient.enc(id)),
        accept: %w[application/json],
    ...
    def update(id : Int32, vlan_translation_policy_request : NetboxClient::VLANTranslationPolicyRequest) : Response(NetboxClient::VLANTranslationPolicy)
      @conn.request(NetboxClient::VLANTranslationPolicy,
        method: :PUT,
        path: "/api/ipam/vlan-translation-policies/{id}/".sub("{id}", NetboxClient.enc(id)),
        body: vlan_translation_policy_request,
