...
module NetboxClient
  ...
  class Ipam::Roles
    ...
    def bulk_destroy(role_request : Array(NetboxClient::RoleRequest)) : Response(Nil)
      @conn.request(Nil,
        method: :DELETE,
        path: "/api/ipam/roles/",
        body: role_request,
    ...
    def bulk_partial_update(role_request : Array(NetboxClient::RoleRequest)) : Response(Array(NetboxClient::Role))
      @conn.request(Array(NetboxClient::Role),
        method: :PATCH,
        path: "/api/ipam/roles/",
        body: role_request,
    ...
    def bulk_update(role_request : Array(NetboxClient::RoleRequest)) : Response(Array(NetboxClient::Role))
      @conn.request(Array(NetboxClient::Role),
        method: :PUT,
        path: "/api/ipam/roles/",
        body: role_request,
    ...
    def create(ipam_roles_create_request : NetboxClient::IpamRolesCreateRequest) : Response(NetboxClient::Role)
      @conn.request(NetboxClient::Role,
        method: :POST,
        path: "/api/ipam/roles/",
        body: ipam_roles_create_request,
        accept: %w[application/json],
        content_type: %w[application/json multipart/form-data],
        auth: %w[cookieAuth tokenAuth])
    end
    ...
    #  Get a role object.
    def retrieve(id : Int32) : Response(NetboxClient::Role)
      @conn.request(NetboxClient::Role,
        method: :GET,
        path: "/api/ipam/roles/{id}/".sub("{id}", NetboxClient.enc(id)),
        accept: %w[application/json],
    ...
    #  Put a role object.
    def update(id : Int32, role_request : NetboxClient::RoleRequest) : Response(NetboxClient::Role)
      @conn.request(NetboxClient::Role,
        method: :PUT,
        path: "/api/ipam/roles/{id}/".sub("{id}", NetboxClient.enc(id)),
        body: role_request,
