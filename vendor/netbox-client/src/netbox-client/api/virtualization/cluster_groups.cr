...
module NetboxClient
  module Api
  class Virtualization::ClusterGroups
    def initialize(@conn : Connection); end

    #  Delete a list of cluster group objects.
    def bulk_destroy(cluster_group_request : Array(NetboxClient::ClusterGroupRequest)) : Response(Nil)
      @conn.request(Nil,
        method: :DELETE,
        path: "/api/virtualization/cluster-groups/",
        body: cluster_group_request,
        accept: %w[],
    ...
    def bulk_partial_update(cluster_group_request : Array(NetboxClient::ClusterGroupRequest)) : Response(Array(NetboxClient::ClusterGroup))
      @conn.request(Array(NetboxClient::ClusterGroup),
        method: :PATCH,
        path: "/api/virtualization/cluster-groups/",
        body: cluster_group_request,
    ...
    def bulk_update(cluster_group_request : Array(NetboxClient::ClusterGroupRequest)) : Response(Array(NetboxClient::ClusterGroup))
      @conn.request(Array(NetboxClient::ClusterGroup),
        method: :PUT,
        path: "/api/virtualization/cluster-groups/",
        body: cluster_group_request,
    ...
    def create(virtualization_cluster_groups_create_request : NetboxClient::VirtualizationClusterGroupsCreateRequest) : Response(NetboxClient::ClusterGroup)
      @conn.request(NetboxClient::ClusterGroup,
        method: :POST,
        path: "/api/virtualization/cluster-groups/",
        body: virtualization_cluster_groups_create_request,
        accept: %w[application/json],
        content_type: %w[application/json multipart/form-data],
        auth: %w[cookieAuth tokenAuth])
    end
    ...
    def partial_update(id : Int32, patched_cluster_group_request : NetboxClient::PatchedClusterGroupRequest? = nil) : Response(NetboxClient::ClusterGroup)
      @conn.request(NetboxClient::ClusterGroup,
        method: :PATCH,
        path: "/api/virtualization/cluster-groups/{id}/".sub("{id}", NetboxClient.enc(id)),
        body: patched_cluster_group_request,
        accept: %w[application/json],
        content_type: %w[application/json multipart/form-data],
        auth: %w[cookieAuth tokenAuth])
    end
    ...
    def retrieve(id : Int32) : Response(NetboxClient::ClusterGroup)
      @conn.request(NetboxClient::ClusterGroup,
        method: :GET,
        path: "/api/virtualization/cluster-groups/{id}/".sub("{id}", NetboxClient.enc(id)),
        accept: %w[application/json],
    ...
    def update(id : Int32, cluster_group_request : NetboxClient::ClusterGroupRequest) : Response(NetboxClient::ClusterGroup)
      @conn.request(NetboxClient::ClusterGroup,
        method: :PUT,
        path: "/api/virtualization/cluster-groups/{id}/".sub("{id}", NetboxClient.enc(id)),
        body: cluster_group_request,
