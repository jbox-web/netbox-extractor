...
module NetboxClient
  module Api
  class Virtualization::ClusterTypes
    def initialize(@conn : Connection); end

    #  Delete a list of cluster type objects.
    def bulk_destroy(cluster_type_request : Array(NetboxClient::ClusterTypeRequest)) : Response(Nil)
      @conn.request(Nil,
        method: :DELETE,
        path: "/api/virtualization/cluster-types/",
        body: cluster_type_request,
        accept: %w[],
    ...
    def bulk_partial_update(cluster_type_request : Array(NetboxClient::ClusterTypeRequest)) : Response(Array(NetboxClient::ClusterType))
      @conn.request(Array(NetboxClient::ClusterType),
        method: :PATCH,
        path: "/api/virtualization/cluster-types/",
        body: cluster_type_request,
    ...
    def bulk_update(cluster_type_request : Array(NetboxClient::ClusterTypeRequest)) : Response(Array(NetboxClient::ClusterType))
      @conn.request(Array(NetboxClient::ClusterType),
        method: :PUT,
        path: "/api/virtualization/cluster-types/",
        body: cluster_type_request,
    ...
    def create(virtualization_cluster_types_create_request : NetboxClient::VirtualizationClusterTypesCreateRequest) : Response(NetboxClient::ClusterType)
      @conn.request(NetboxClient::ClusterType,
        method: :POST,
        path: "/api/virtualization/cluster-types/",
        body: virtualization_cluster_types_create_request,
        accept: %w[application/json],
        content_type: %w[application/json multipart/form-data],
        auth: %w[cookieAuth tokenAuth])
    end
    ...
    def destroy(id : Int32) : Response(Nil)
      @conn.request(Nil,
        method: :DELETE,
        path: "/api/virtualization/cluster-types/{id}/".sub("{id}", NetboxClient.enc(id)),
        accept: %w[],
        auth: %w[cookieAuth tokenAuth])
    end

    #  Get a list of cluster type objects.
    def list(*, created : Array(Time)? = nil, created__empty : Array(Time)? = nil, created__gt : Array(Time)? = nil, created__gte : Array(Time)? = nil, created__lt : Array(Time)? = nil, created__lte : Array(Time)? = nil, created__n : Array(Time)? = nil, created_by_request : String? = nil, description : Array(String)? = nil, description__empty : Bool? = nil, description__ic : Array(String)? = nil, description__ie : Array(String)? = nil, description__iew : Array(String)? = nil, description__iregex : Array(String)? = nil, description__isw : Array(String)? = nil, description__n : Array(String)? = nil, description__nic : Array(String)? = nil, description__nie : Array(String)? = nil, description__niew : Array(String)? = nil, description__nisw : Array(String)? = nil, description__regex : Array(String)? = nil, id : Array(Int32)? = nil, id__empty : Bool? = nil, id__gt : Array(Int32)? = nil, id__gte : Array(Int32)? = nil, id__lt : Array(Int32)? = nil, id__lte : Array(Int32)? = nil, id__n : Array(Int32)? = nil, last_updated : Array(Time)? = nil, last_updated__empty : Array(Time)? = nil, last_updated__gt : Array(Time)? = nil, last_updated__gte : Array(Time)? = nil, last_updated__lt : Array(Time)? = nil, last_updated__lte : Array(Time)? = nil, last_updated__n : Array(Time)? = nil, limit : Int32? = nil, modified_by_request : String? = nil, name : Array(String)? = nil, name__empty : Bool? = nil, name__ic : Array(String)? = nil, name__ie : Array(String)? = nil, name__iew : Array(String)? = nil, name__iregex : Array(String)? = nil, name__isw : Array(String)? = nil, name__n : Array(String)? = nil, name__nic : Array(String)? = nil, name__nie : Array(String)? = nil, name__niew : Array(String)? = nil, name__nisw : Array(String)? = nil, name__regex : Array(String)? = nil, offset : Int32? = nil, ordering : String? = nil, q : String? = nil, slug : Array(String)? = nil, slug__empty : Bool? = nil, slug__ic : Array(String)? = nil, slug__ie : Array(String)? = nil, slug__iew : Array(String)? = nil, slug__iregex : Array(String)? = nil, slug__isw : Array(String)? = nil, slug__n : Array(String)? = nil, slug__nic : Array(String)? = nil, slug__nie : Array(String)? = nil, slug__niew : Array(String)? = nil, slug__nisw : Array(String)? = nil, slug__regex : Array(String)? = nil, tag : Array(String)? = nil, tag__n : Array(String)? = nil, tag_id : Array(String)? = nil, tag_id__n : Array(String)? = nil, updated_by_request : String? = nil) : Response(NetboxClient::PaginatedClusterTypeList)
      @conn.request(NetboxClient::PaginatedClusterTypeList,
        method: :GET,
        path: "/api/virtualization/cluster-types/",
    ...
    def partial_update(id : Int32, patched_cluster_type_request : NetboxClient::PatchedClusterTypeRequest? = nil) : Response(NetboxClient::ClusterType)
      @conn.request(NetboxClient::ClusterType,
        method: :PATCH,
        path: "/api/virtualization/cluster-types/{id}/".sub("{id}", NetboxClient.enc(id)),
        body: patched_cluster_type_request,
        accept: %w[application/json],
        content_type: %w[application/json multipart/form-data],
        auth: %w[cookieAuth tokenAuth])
    end
    ...
    def retrieve(id : Int32) : Response(NetboxClient::ClusterType)
      @conn.request(NetboxClient::ClusterType,
        method: :GET,
        path: "/api/virtualization/cluster-types/{id}/".sub("{id}", NetboxClient.enc(id)),
        accept: %w[application/json],
    ...
    def update(id : Int32, cluster_type_request : NetboxClient::ClusterTypeRequest) : Response(NetboxClient::ClusterType)
      @conn.request(NetboxClient::ClusterType,
        method: :PUT,
        path: "/api/virtualization/cluster-types/{id}/".sub("{id}", NetboxClient.enc(id)),
        body: cluster_type_request,
