...
module NetboxClient
  module Api
  class Dcim::RearPorts
    def initialize(@conn : Connection); end

    #  Delete a list of rear port objects.
    def bulk_destroy(rear_port_request : Array(NetboxClient::RearPortRequest)) : Response(Nil)
      @conn.request(Nil,
        method: :DELETE,
        path: "/api/dcim/rear-ports/",
        body: rear_port_request,
        accept: %w[],
    ...
    def bulk_partial_update(rear_port_request : Array(NetboxClient::RearPortRequest)) : Response(Array(NetboxClient::RearPort))
      @conn.request(Array(NetboxClient::RearPort),
        method: :PATCH,
        path: "/api/dcim/rear-ports/",
        body: rear_port_request,
    ...
    def bulk_update(rear_port_request : Array(NetboxClient::RearPortRequest)) : Response(Array(NetboxClient::RearPort))
      @conn.request(Array(NetboxClient::RearPort),
        method: :PUT,
        path: "/api/dcim/rear-ports/",
        body: rear_port_request,
    ...
    def create(dcim_rear_ports_create_request : NetboxClient::DcimRearPortsCreateRequest) : Response(NetboxClient::RearPort)
      @conn.request(NetboxClient::RearPort,
        method: :POST,
        path: "/api/dcim/rear-ports/",
        body: dcim_rear_ports_create_request,
        accept: %w[application/json],
        content_type: %w[application/json multipart/form-data],
        auth: %w[cookieAuth tokenAuth])
    end
    ...
    def paths_retrieve(id : Int32) : Response(NetboxClient::RearPort)
      @conn.request(NetboxClient::RearPort,
        method: :GET,
        path: "/api/dcim/rear-ports/{id}/paths/".sub("{id}", NetboxClient.enc(id)),
        accept: %w[application/json],
        auth: %w[cookieAuth tokenAuth])
    end

    #  Get a rear port object.
    def retrieve(id : Int32) : Response(NetboxClient::RearPort)
      @conn.request(NetboxClient::RearPort,
        method: :GET,
        path: "/api/dcim/rear-ports/{id}/".sub("{id}", NetboxClient.enc(id)),
        accept: %w[application/json],
    ...
    def update(id : Int32, writable_rear_port_request : NetboxClient::WritableRearPortRequest) : Response(NetboxClient::RearPort)
      @conn.request(NetboxClient::RearPort,
        method: :PUT,
        path: "/api/dcim/rear-ports/{id}/".sub("{id}", NetboxClient.enc(id)),
        body: writable_rear_port_request,
        accept: %w[application/json],
        content_type: %w[application/json multipart/form-data],
        auth: %w[cookieAuth tokenAuth])
    end
