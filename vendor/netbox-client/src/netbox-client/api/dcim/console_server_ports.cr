...
module NetboxClient
  module Api
  class Dcim::ConsoleServerPorts
    def initialize(@conn : Connection); end

    #  Delete a list of console server port objects.
    def bulk_destroy(console_server_port_request : Array(NetboxClient::ConsoleServerPortRequest)) : Response(Nil)
      @conn.request(Nil,
        method: :DELETE,
        path: "/api/dcim/console-server-ports/",
        body: console_server_port_request,
        accept: %w[],
    ...
    def bulk_partial_update(console_server_port_request : Array(NetboxClient::ConsoleServerPortRequest)) : Response(Array(NetboxClient::ConsoleServerPort))
      @conn.request(Array(NetboxClient::ConsoleServerPort),
        method: :PATCH,
        path: "/api/dcim/console-server-ports/",
        body: console_server_port_request,
    ...
    def bulk_update(console_server_port_request : Array(NetboxClient::ConsoleServerPortRequest)) : Response(Array(NetboxClient::ConsoleServerPort))
      @conn.request(Array(NetboxClient::ConsoleServerPort),
        method: :PUT,
        path: "/api/dcim/console-server-ports/",
        body: console_server_port_request,
    ...
    def create(dcim_console_server_ports_create_request : NetboxClient::DcimConsoleServerPortsCreateRequest) : Response(NetboxClient::ConsoleServerPort)
      @conn.request(NetboxClient::ConsoleServerPort,
        method: :POST,
        path: "/api/dcim/console-server-ports/",
        body: dcim_console_server_ports_create_request,
        accept: %w[application/json],
        content_type: %w[application/json multipart/form-data],
        auth: %w[cookieAuth tokenAuth])
    end
    ...
    def partial_update(id : Int32, patched_writable_console_server_port_request : NetboxClient::PatchedWritableConsoleServerPortRequest? = nil) : Response(NetboxClient::ConsoleServerPort)
      @conn.request(NetboxClient::ConsoleServerPort,
        method: :PATCH,
        path: "/api/dcim/console-server-ports/{id}/".sub("{id}", NetboxClient.enc(id)),
        body: patched_writable_console_server_port_request,
        accept: %w[application/json],
        content_type: %w[application/json multipart/form-data],
        auth: %w[cookieAuth tokenAuth])
    end
    ...
    def retrieve(id : Int32) : Response(NetboxClient::ConsoleServerPort)
      @conn.request(NetboxClient::ConsoleServerPort,
        method: :GET,
        path: "/api/dcim/console-server-ports/{id}/".sub("{id}", NetboxClient.enc(id)),
        accept: %w[application/json],
    ...
    def trace_retrieve(id : Int32) : Response(NetboxClient::ConsoleServerPort)
      @conn.request(NetboxClient::ConsoleServerPort,
        method: :GET,
        path: "/api/dcim/console-server-ports/{id}/trace/".sub("{id}", NetboxClient.enc(id)),
        accept: %w[application/json],
        auth: %w[cookieAuth tokenAuth])
    end

    #  Put a console server port object.
    def update(id : Int32, writable_console_server_port_request : NetboxClient::WritableConsoleServerPortRequest) : Response(NetboxClient::ConsoleServerPort)
      @conn.request(NetboxClient::ConsoleServerPort,
        method: :PUT,
        path: "/api/dcim/console-server-ports/{id}/".sub("{id}", NetboxClient.enc(id)),
        body: writable_console_server_port_request,
        accept: %w[application/json],
        content_type: %w[application/json multipart/form-data],
        auth: %w[cookieAuth tokenAuth])
    end
