...
module NetboxClient
  module Api
  class Dcim::PowerPorts
    def initialize(@conn : Connection); end

    #  Delete a list of power port objects.
    def bulk_destroy(power_port_request : Array(NetboxClient::PowerPortRequest)) : Response(Nil)
      @conn.request(Nil,
        method: :DELETE,
        path: "/api/dcim/power-ports/",
        body: power_port_request,
        accept: %w[],
    ...
    def bulk_partial_update(power_port_request : Array(NetboxClient::PowerPortRequest)) : Response(Array(NetboxClient::PowerPort))
      @conn.request(Array(NetboxClient::PowerPort),
        method: :PATCH,
        path: "/api/dcim/power-ports/",
        body: power_port_request,
    ...
    def bulk_update(power_port_request : Array(NetboxClient::PowerPortRequest)) : Response(Array(NetboxClient::PowerPort))
      @conn.request(Array(NetboxClient::PowerPort),
        method: :PUT,
        path: "/api/dcim/power-ports/",
        body: power_port_request,
    ...
    def create(dcim_power_ports_create_request : NetboxClient::DcimPowerPortsCreateRequest) : Response(NetboxClient::PowerPort)
      @conn.request(NetboxClient::PowerPort,
        method: :POST,
        path: "/api/dcim/power-ports/",
        body: dcim_power_ports_create_request,
        accept: %w[application/json],
        content_type: %w[application/json multipart/form-data],
        auth: %w[cookieAuth tokenAuth])
    end
    ...
    def retrieve(id : Int32) : Response(NetboxClient::PowerPort)
      @conn.request(NetboxClient::PowerPort,
        method: :GET,
        path: "/api/dcim/power-ports/{id}/".sub("{id}", NetboxClient.enc(id)),
        accept: %w[application/json],
    ...
    def trace_retrieve(id : Int32) : Response(NetboxClient::PowerPort)
      @conn.request(NetboxClient::PowerPort,
        method: :GET,
        path: "/api/dcim/power-ports/{id}/trace/".sub("{id}", NetboxClient.enc(id)),
        accept: %w[application/json],
        auth: %w[cookieAuth tokenAuth])
    end

    #  Put a power port object.
    def update(id : Int32, writable_power_port_request : NetboxClient::WritablePowerPortRequest) : Response(NetboxClient::PowerPort)
      @conn.request(NetboxClient::PowerPort,
        method: :PUT,
        path: "/api/dcim/power-ports/{id}/".sub("{id}", NetboxClient.enc(id)),
        body: writable_power_port_request,
        accept: %w[application/json],
        content_type: %w[application/json multipart/form-data],
        auth: %w[cookieAuth tokenAuth])
    end
