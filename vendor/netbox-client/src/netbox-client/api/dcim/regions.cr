...
module NetboxClient
  ...
  class Dcim::Regions
    ...
    def bulk_destroy(region_request : Array(NetboxClient::RegionRequest)) : Response(Nil)
      @conn.request(Nil,
        method: :DELETE,
    ...
    def bulk_partial_update(region_request : Array(NetboxClient::RegionRequest)) : Response(Array(NetboxClient::Region))
      @conn.request(Array(NetboxClient::Region),
        method: :PATCH,
        path: "/api/dcim/regions/",
        body: region_request,
    ...
    def bulk_update(region_request : Array(NetboxClient::RegionRequest)) : Response(Array(NetboxClient::Region))
      @conn.request(Array(NetboxClient::Region),
        method: :PUT,
        path: "/api/dcim/regions/",
        body: region_request,
    ...
    def create(dcim_regions_create_request : NetboxClient::DcimRegionsCreateRequest) : Response(NetboxClient::Region)
      @conn.request(NetboxClient::Region,
        method: :POST,
        path: "/api/dcim/regions/",
        body: dcim_regions_create_request,
        accept: %w[application/json],
        content_type: %w[application/json multipart/form-data],
        auth: %w[cookieAuth tokenAuth])
    end
    ...
    def partial_update(id : Int32, patched_writable_region_request : NetboxClient::PatchedWritableRegionRequest? = nil) : Response(NetboxClient::Region)
      @conn.request(NetboxClient::Region,
        method: :PATCH,
        path: "/api/dcim/regions/{id}/".sub("{id}", NetboxClient.enc(id)),
        body: patched_writable_region_request,
        accept: %w[application/json],
        content_type: %w[application/json multipart/form-data],
        auth: %w[cookieAuth tokenAuth])
    end
    ...
    #  Get a region object.
    def retrieve(id : Int32) : Response(NetboxClient::Region)
      @conn.request(NetboxClient::Region,
        method: :GET,
        path: "/api/dcim/regions/{id}/".sub("{id}", NetboxClient.enc(id)),
        accept: %w[application/json],
    ...
    #  Put a region object.
    def update(id : Int32, writable_region_request : NetboxClient::WritableRegionRequest) : Response(NetboxClient::Region)
      @conn.request(NetboxClient::Region,
        method: :PUT,
        path: "/api/dcim/regions/{id}/".sub("{id}", NetboxClient.enc(id)),
        body: writable_region_request,
        accept: %w[application/json],
        content_type: %w[application/json multipart/form-data],
        auth: %w[cookieAuth tokenAuth])
    end
