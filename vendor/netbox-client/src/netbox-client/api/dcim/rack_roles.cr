...
module NetboxClient
  module Api
  class Dcim::RackRoles
    def initialize(@conn : Connection); end

    #  Delete a list of rack role objects.
    def bulk_destroy(rack_role_request : Array(NetboxClient::RackRoleRequest)) : Response(Nil)
      @conn.request(Nil,
        method: :DELETE,
        path: "/api/dcim/rack-roles/",
        body: rack_role_request,
        accept: %w[],
    ...
    def bulk_partial_update(rack_role_request : Array(NetboxClient::RackRoleRequest)) : Response(Array(NetboxClient::RackRole))
      @conn.request(Array(NetboxClient::RackRole),
        method: :PATCH,
        path: "/api/dcim/rack-roles/",
        body: rack_role_request,
    ...
    def bulk_update(rack_role_request : Array(NetboxClient::RackRoleRequest)) : Response(Array(NetboxClient::RackRole))
      @conn.request(Array(NetboxClient::RackRole),
        method: :PUT,
        path: "/api/dcim/rack-roles/",
        body: rack_role_request,
    ...
    def create(dcim_rack_roles_create_request : NetboxClient::DcimRackRolesCreateRequest) : Response(NetboxClient::RackRole)
      @conn.request(NetboxClient::RackRole,
        method: :POST,
        path: "/api/dcim/rack-roles/",
        body: dcim_rack_roles_create_request,
        accept: %w[application/json],
        content_type: %w[application/json multipart/form-data],
        auth: %w[cookieAuth tokenAuth])
    end
    ...
    def partial_update(id : Int32, patched_rack_role_request : NetboxClient::PatchedRackRoleRequest? = nil) : Response(NetboxClient::RackRole)
      @conn.request(NetboxClient::RackRole,
        method: :PATCH,
        path: "/api/dcim/rack-roles/{id}/".sub("{id}", NetboxClient.enc(id)),
        body: patched_rack_role_request,
        accept: %w[application/json],
        content_type: %w[application/json multipart/form-data],
        auth: %w[cookieAuth tokenAuth])
    end
    ...
    def retrieve(id : Int32) : Response(NetboxClient::RackRole)
      @conn.request(NetboxClient::RackRole,
        method: :GET,
        path: "/api/dcim/rack-roles/{id}/".sub("{id}", NetboxClient.enc(id)),
        accept: %w[application/json],
    ...
    def update(id : Int32, rack_role_request : NetboxClient::RackRoleRequest) : Response(NetboxClient::RackRole)
      @conn.request(NetboxClient::RackRole,
        method: :PUT,
        path: "/api/dcim/rack-roles/{id}/".sub("{id}", NetboxClient.enc(id)),
        body: rack_role_request,
