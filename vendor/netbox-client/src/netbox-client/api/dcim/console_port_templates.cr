...
module NetboxClient
  module Api
  class Dcim::ConsolePortTemplates
    def initialize(@conn : Connection); end

    #  Delete a list of console port template objects.
    def bulk_destroy(console_port_template_request : Array(NetboxClient::ConsolePortTemplateRequest)) : Response(Nil)
      @conn.request(Nil,
        method: :DELETE,
        path: "/api/dcim/console-port-templates/",
        body: console_port_template_request,
        accept: %w[],
    ...
    def bulk_partial_update(console_port_template_request : Array(NetboxClient::ConsolePortTemplateRequest)) : Response(Array(NetboxClient::ConsolePortTemplate))
      @conn.request(Array(NetboxClient::ConsolePortTemplate),
        method: :PATCH,
        path: "/api/dcim/console-port-templates/",
        body: console_port_template_request,
    ...
    def bulk_update(console_port_template_request : Array(NetboxClient::ConsolePortTemplateRequest)) : Response(Array(NetboxClient::ConsolePortTemplate))
      @conn.request(Array(NetboxClient::ConsolePortTemplate),
        method: :PUT,
        path: "/api/dcim/console-port-templates/",
        body: console_port_template_request,
    ...
    def create(dcim_console_port_templates_create_request : NetboxClient::DcimConsolePortTemplatesCreateRequest) : Response(NetboxClient::ConsolePortTemplate)
      @conn.request(NetboxClient::ConsolePortTemplate,
        method: :POST,
        path: "/api/dcim/console-port-templates/",
        body: dcim_console_port_templates_create_request,
        accept: %w[application/json],
        content_type: %w[application/json multipart/form-data],
        auth: %w[cookieAuth tokenAuth])
    end
    ...
    def partial_update(id : Int32, patched_writable_console_port_template_request : NetboxClient::PatchedWritableConsolePortTemplateRequest? = nil) : Response(NetboxClient::ConsolePortTemplate)
      @conn.request(NetboxClient::ConsolePortTemplate,
        method: :PATCH,
        path: "/api/dcim/console-port-templates/{id}/".sub("{id}", NetboxClient.enc(id)),
        body: patched_writable_console_port_template_request,
        accept: %w[application/json],
        content_type: %w[application/json multipart/form-data],
        auth: %w[cookieAuth tokenAuth])
    end
    ...
    def retrieve(id : Int32) : Response(NetboxClient::ConsolePortTemplate)
      @conn.request(NetboxClient::ConsolePortTemplate,
        method: :GET,
        path: "/api/dcim/console-port-templates/{id}/".sub("{id}", NetboxClient.enc(id)),
        accept: %w[application/json],
    ...
    def update(id : Int32, writable_console_port_template_request : NetboxClient::WritableConsolePortTemplateRequest) : Response(NetboxClient::ConsolePortTemplate)
      @conn.request(NetboxClient::ConsolePortTemplate,
        method: :PUT,
        path: "/api/dcim/console-port-templates/{id}/".sub("{id}", NetboxClient.enc(id)),
        body: writable_console_port_template_request,
        accept: %w[application/json],
        content_type: %w[application/json multipart/form-data],
        auth: %w[cookieAuth tokenAuth])
    end
