...
module NetboxClient
  module Api
  class Dcim::Platforms
    def initialize(@conn : Connection); end

    #  Delete a list of platform objects.
    def bulk_destroy(platform_request : Array(NetboxClient::PlatformRequest)) : Response(Nil)
      @conn.request(Nil,
        method: :DELETE,
        path: "/api/dcim/platforms/",
        body: platform_request,
        accept: %w[],
    ...
    def bulk_partial_update(platform_request : Array(NetboxClient::PlatformRequest)) : Response(Array(NetboxClient::Platform))
      @conn.request(Array(NetboxClient::Platform),
        method: :PATCH,
        path: "/api/dcim/platforms/",
        body: platform_request,
    ...
    def bulk_update(platform_request : Array(NetboxClient::PlatformRequest)) : Response(Array(NetboxClient::Platform))
      @conn.request(Array(NetboxClient::Platform),
        method: :PUT,
        path: "/api/dcim/platforms/",
        body: platform_request,
    ...
    def create(dcim_platforms_create_request : NetboxClient::DcimPlatformsCreateRequest) : Response(NetboxClient::Platform)
      @conn.request(NetboxClient::Platform,
        method: :POST,
        path: "/api/dcim/platforms/",
        body: dcim_platforms_create_request,
        accept: %w[application/json],
        content_type: %w[application/json multipart/form-data],
        auth: %w[cookieAuth tokenAuth])
    end
    ...
    def retrieve(id : Int32) : Response(NetboxClient::Platform)
      @conn.request(NetboxClient::Platform,
        method: :GET,
        path: "/api/dcim/platforms/{id}/".sub("{id}", NetboxClient.enc(id)),
        accept: %w[application/json],
    ...
    def update(id : Int32, writable_platform_request : NetboxClient::WritablePlatformRequest) : Response(NetboxClient::Platform)
      @conn.request(NetboxClient::Platform,
        method: :PUT,
        path: "/api/dcim/platforms/{id}/".sub("{id}", NetboxClient.enc(id)),
        body: writable_platform_request,
        accept: %w[application/json],
        content_type: %w[application/json multipart/form-data],
        auth: %w[cookieAuth tokenAuth])
    end
