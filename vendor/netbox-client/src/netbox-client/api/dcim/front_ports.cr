...
module NetboxClient
  module Api
  class Dcim::FrontPorts
    def initialize(@conn : Connection); end

    #  Delete a list of front port objects.
    def bulk_destroy(front_port_request : Array(NetboxClient::FrontPortRequest)) : Response(Nil)
      @conn.request(Nil,
        method: :DELETE,
        path: "/api/dcim/front-ports/",
        body: front_port_request,
        accept: %w[],
    ...
    def bulk_partial_update(front_port_request : Array(NetboxClient::FrontPortRequest)) : Response(Array(NetboxClient::FrontPort))
      @conn.request(Array(NetboxClient::FrontPort),
        method: :PATCH,
        path: "/api/dcim/front-ports/",
        body: front_port_request,
    ...
    def bulk_update(front_port_request : Array(NetboxClient::FrontPortRequest)) : Response(Array(NetboxClient::FrontPort))
      @conn.request(Array(NetboxClient::FrontPort),
        method: :PUT,
        path: "/api/dcim/front-ports/",
        body: front_port_request,
    ...
    def create(dcim_front_ports_create_request : NetboxClient::DcimFrontPortsCreateRequest) : Response(NetboxClient::FrontPort)
      @conn.request(NetboxClient::FrontPort,
        method: :POST,
        path: "/api/dcim/front-ports/",
        body: dcim_front_ports_create_request,
        accept: %w[application/json],
        content_type: %w[application/json multipart/form-data],
        auth: %w[cookieAuth tokenAuth])
    end
    ...
    def paths_retrieve(id : Int32) : Response(NetboxClient::FrontPort)
      @conn.request(NetboxClient::FrontPort,
        method: :GET,
        path: "/api/dcim/front-ports/{id}/paths/".sub("{id}", NetboxClient.enc(id)),
        accept: %w[application/json],
        auth: %w[cookieAuth tokenAuth])
    end

    #  Get a front port object.
    def retrieve(id : Int32) : Response(NetboxClient::FrontPort)
      @conn.request(NetboxClient::FrontPort,
        method: :GET,
        path: "/api/dcim/front-ports/{id}/".sub("{id}", NetboxClient.enc(id)),
        accept: %w[application/json],
    ...
    def update(id : Int32, writable_front_port_request : NetboxClient::WritableFrontPortRequest) : Response(NetboxClient::FrontPort)
      @conn.request(NetboxClient::FrontPort,
        method: :PUT,
        path: "/api/dcim/front-ports/{id}/".sub("{id}", NetboxClient.enc(id)),
        body: writable_front_port_request,
        accept: %w[application/json],
        content_type: %w[application/json multipart/form-data],
        auth: %w[cookieAuth tokenAuth])
    end
