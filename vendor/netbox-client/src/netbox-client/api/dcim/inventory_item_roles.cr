...
module NetboxClient
  module Api
  class Dcim::InventoryItemRoles
    def initialize(@conn : Connection); end

    #  Delete a list of inventory item role objects.
    def bulk_destroy(inventory_item_role_request : Array(NetboxClient::InventoryItemRoleRequest)) : Response(Nil)
      @conn.request(Nil,
        method: :DELETE,
        path: "/api/dcim/inventory-item-roles/",
        body: inventory_item_role_request,
        accept: %w[],
    ...
    def bulk_partial_update(inventory_item_role_request : Array(NetboxClient::InventoryItemRoleRequest)) : Response(Array(NetboxClient::InventoryItemRole))
      @conn.request(Array(NetboxClient::InventoryItemRole),
        method: :PATCH,
        path: "/api/dcim/inventory-item-roles/",
        body: inventory_item_role_request,
    ...
    def bulk_update(inventory_item_role_request : Array(NetboxClient::InventoryItemRoleRequest)) : Response(Array(NetboxClient::InventoryItemRole))
      @conn.request(Array(NetboxClient::InventoryItemRole),
        method: :PUT,
        path: "/api/dcim/inventory-item-roles/",
        body: inventory_item_role_request,
    ...
    def create(dcim_inventory_item_roles_create_request : NetboxClient::DcimInventoryItemRolesCreateRequest) : Response(NetboxClient::InventoryItemRole)
      @conn.request(NetboxClient::InventoryItemRole,
        method: :POST,
        path: "/api/dcim/inventory-item-roles/",
        body: dcim_inventory_item_roles_create_request,
        accept: %w[application/json],
        content_type: %w[application/json multipart/form-data],
        auth: %w[cookieAuth tokenAuth])
    end
    ...
    def partial_update(id : Int32, patched_inventory_item_role_request : NetboxClient::PatchedInventoryItemRoleRequest? = nil) : Response(NetboxClient::InventoryItemRole)
      @conn.request(NetboxClient::InventoryItemRole,
        method: :PATCH,
        path: "/api/dcim/inventory-item-roles/{id}/".sub("{id}", NetboxClient.enc(id)),
        body: patched_inventory_item_role_request,
        accept: %w[application/json],
        content_type: %w[application/json multipart/form-data],
        auth: %w[cookieAuth tokenAuth])
    end
    ...
    def retrieve(id : Int32) : Response(NetboxClient::InventoryItemRole)
      @conn.request(NetboxClient::InventoryItemRole,
        method: :GET,
        path: "/api/dcim/inventory-item-roles/{id}/".sub("{id}", NetboxClient.enc(id)),
        accept: %w[application/json],
    ...
    def update(id : Int32, inventory_item_role_request : NetboxClient::InventoryItemRoleRequest) : Response(NetboxClient::InventoryItemRole)
      @conn.request(NetboxClient::InventoryItemRole,
        method: :PUT,
        path: "/api/dcim/inventory-item-roles/{id}/".sub("{id}", NetboxClient.enc(id)),
        body: inventory_item_role_request,
