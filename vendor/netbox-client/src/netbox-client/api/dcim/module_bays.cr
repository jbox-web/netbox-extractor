...
module NetboxClient
  module Api
  class Dcim::ModuleBays
    def initialize(@conn : Connection); end

    #  Delete a list of module bay objects.
    def bulk_destroy(module_bay_request : Array(NetboxClient::ModuleBayRequest)) : Response(Nil)
      @conn.request(Nil,
        method: :DELETE,
        path: "/api/dcim/module-bays/",
        body: module_bay_request,
        accept: %w[],
    ...
    def bulk_partial_update(module_bay_request : Array(NetboxClient::ModuleBayRequest)) : Response(Array(NetboxClient::ModuleBay))
      @conn.request(Array(NetboxClient::ModuleBay),
        method: :PATCH,
        path: "/api/dcim/module-bays/",
        body: module_bay_request,
    ...
    def bulk_update(module_bay_request : Array(NetboxClient::ModuleBayRequest)) : Response(Array(NetboxClient::ModuleBay))
      @conn.request(Array(NetboxClient::ModuleBay),
        method: :PUT,
        path: "/api/dcim/module-bays/",
        body: module_bay_request,
    ...
    def create(dcim_module_bays_create_request : NetboxClient::DcimModuleBaysCreateRequest) : Response(NetboxClient::ModuleBay)
      @conn.request(NetboxClient::ModuleBay,
        method: :POST,
        path: "/api/dcim/module-bays/",
        body: dcim_module_bays_create_request,
        accept: %w[application/json],
        content_type: %w[application/json multipart/form-data],
        auth: %w[cookieAuth tokenAuth])
    end
    ...
    def retrieve(id : Int32) : Response(NetboxClient::ModuleBay)
      @conn.request(NetboxClient::ModuleBay,
        method: :GET,
        path: "/api/dcim/module-bays/{id}/".sub("{id}", NetboxClient.enc(id)),
        accept: %w[application/json],
    ...
    def update(id : Int32, module_bay_request : NetboxClient::ModuleBayRequest) : Response(NetboxClient::ModuleBay)
      @conn.request(NetboxClient::ModuleBay,
        method: :PUT,
        path: "/api/dcim/module-bays/{id}/".sub("{id}", NetboxClient.enc(id)),
        body: module_bay_request,
