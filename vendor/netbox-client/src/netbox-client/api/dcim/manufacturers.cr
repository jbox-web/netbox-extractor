...
module NetboxClient
  module Api
  class Dcim::Manufacturers
    def initialize(@conn : Connection); end

    #  Delete a list of manufacturer objects.
    def bulk_destroy(manufacturer_request : Array(NetboxClient::ManufacturerRequest)) : Response(Nil)
      @conn.request(Nil,
        method: :DELETE,
        path: "/api/dcim/manufacturers/",
        body: manufacturer_request,
        accept: %w[],
    ...
    def bulk_partial_update(manufacturer_request : Array(NetboxClient::ManufacturerRequest)) : Response(Array(NetboxClient::Manufacturer))
      @conn.request(Array(NetboxClient::Manufacturer),
        method: :PATCH,
        path: "/api/dcim/manufacturers/",
        body: manufacturer_request,
    ...
    def bulk_update(manufacturer_request : Array(NetboxClient::ManufacturerRequest)) : Response(Array(NetboxClient::Manufacturer))
      @conn.request(Array(NetboxClient::Manufacturer),
        method: :PUT,
        path: "/api/dcim/manufacturers/",
        body: manufacturer_request,
    ...
    def create(dcim_manufacturers_create_request : NetboxClient::DcimManufacturersCreateRequest) : Response(NetboxClient::Manufacturer)
      @conn.request(NetboxClient::Manufacturer,
        method: :POST,
        path: "/api/dcim/manufacturers/",
        body: dcim_manufacturers_create_request,
        accept: %w[application/json],
        content_type: %w[application/json multipart/form-data],
        auth: %w[cookieAuth tokenAuth])
    end
    ...
    def partial_update(id : Int32, patched_manufacturer_request : NetboxClient::PatchedManufacturerRequest? = nil) : Response(NetboxClient::Manufacturer)
      @conn.request(NetboxClient::Manufacturer,
        method: :PATCH,
        path: "/api/dcim/manufacturers/{id}/".sub("{id}", NetboxClient.enc(id)),
        body: patched_manufacturer_request,
        accept: %w[application/json],
        content_type: %w[application/json multipart/form-data],
        auth: %w[cookieAuth tokenAuth])
    end
    ...
    def retrieve(id : Int32) : Response(NetboxClient::Manufacturer)
      @conn.request(NetboxClient::Manufacturer,
        method: :GET,
        path: "/api/dcim/manufacturers/{id}/".sub("{id}", NetboxClient.enc(id)),
        accept: %w[application/json],
    ...
    def update(id : Int32, manufacturer_request : NetboxClient::ManufacturerRequest) : Response(NetboxClient::Manufacturer)
      @conn.request(NetboxClient::Manufacturer,
        method: :PUT,
        path: "/api/dcim/manufacturers/{id}/".sub("{id}", NetboxClient.enc(id)),
        body: manufacturer_request,
