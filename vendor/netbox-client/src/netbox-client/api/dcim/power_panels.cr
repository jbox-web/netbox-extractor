...
module NetboxClient
  module Api
  class Dcim::PowerPanels
    def initialize(@conn : Connection); end

    #  Delete a list of power panel objects.
    def bulk_destroy(power_panel_request : Array(NetboxClient::PowerPanelRequest)) : Response(Nil)
      @conn.request(Nil,
        method: :DELETE,
        path: "/api/dcim/power-panels/",
        body: power_panel_request,
        accept: %w[],
    ...
    def bulk_partial_update(power_panel_request : Array(NetboxClient::PowerPanelRequest)) : Response(Array(NetboxClient::PowerPanel))
      @conn.request(Array(NetboxClient::PowerPanel),
        method: :PATCH,
        path: "/api/dcim/power-panels/",
        body: power_panel_request,
    ...
    def bulk_update(power_panel_request : Array(NetboxClient::PowerPanelRequest)) : Response(Array(NetboxClient::PowerPanel))
      @conn.request(Array(NetboxClient::PowerPanel),
        method: :PUT,
        path: "/api/dcim/power-panels/",
        body: power_panel_request,
    ...
    def create(dcim_power_panels_create_request : NetboxClient::DcimPowerPanelsCreateRequest) : Response(NetboxClient::PowerPanel)
      @conn.request(NetboxClient::PowerPanel,
        method: :POST,
        path: "/api/dcim/power-panels/",
        body: dcim_power_panels_create_request,
        accept: %w[application/json],
        content_type: %w[application/json multipart/form-data],
        auth: %w[cookieAuth tokenAuth])
    end
    ...
    def retrieve(id : Int32) : Response(NetboxClient::PowerPanel)
      @conn.request(NetboxClient::PowerPanel,
        method: :GET,
        path: "/api/dcim/power-panels/{id}/".sub("{id}", NetboxClient.enc(id)),
        accept: %w[application/json],
    ...
    def update(id : Int32, power_panel_request : NetboxClient::PowerPanelRequest) : Response(NetboxClient::PowerPanel)
      @conn.request(NetboxClient::PowerPanel,
        method: :PUT,
        path: "/api/dcim/power-panels/{id}/".sub("{id}", NetboxClient.enc(id)),
        body: power_panel_request,
