...
module NetboxClient
  module Api
  class Dcim::ModuleTypeProfiles
    def initialize(@conn : Connection); end

    #  Delete a list of module type profile objects.
    def bulk_destroy(module_type_profile_request : Array(NetboxClient::ModuleTypeProfileRequest)) : Response(Nil)
      @conn.request(Nil,
        method: :DELETE,
        path: "/api/dcim/module-type-profiles/",
        body: module_type_profile_request,
        accept: %w[],
    ...
    def bulk_partial_update(module_type_profile_request : Array(NetboxClient::ModuleTypeProfileRequest)) : Response(Array(NetboxClient::ModuleTypeProfile))
      @conn.request(Array(NetboxClient::ModuleTypeProfile),
        method: :PATCH,
        path: "/api/dcim/module-type-profiles/",
        body: module_type_profile_request,
    ...
    def bulk_update(module_type_profile_request : Array(NetboxClient::ModuleTypeProfileRequest)) : Response(Array(NetboxClient::ModuleTypeProfile))
      @conn.request(Array(NetboxClient::ModuleTypeProfile),
        method: :PUT,
        path: "/api/dcim/module-type-profiles/",
        body: module_type_profile_request,
    ...
    def create(dcim_module_type_profiles_create_request : NetboxClient::DcimModuleTypeProfilesCreateRequest) : Response(NetboxClient::ModuleTypeProfile)
      @conn.request(NetboxClient::ModuleTypeProfile,
        method: :POST,
        path: "/api/dcim/module-type-profiles/",
        body: dcim_module_type_profiles_create_request,
        accept: %w[application/json],
        content_type: %w[application/json multipart/form-data],
        auth: %w[cookieAuth tokenAuth])
    end
    ...
    def partial_update(id : Int32, patched_module_type_profile_request : NetboxClient::PatchedModuleTypeProfileRequest? = nil) : Response(NetboxClient::ModuleTypeProfile)
      @conn.request(NetboxClient::ModuleTypeProfile,
        method: :PATCH,
        path: "/api/dcim/module-type-profiles/{id}/".sub("{id}", NetboxClient.enc(id)),
        body: patched_module_type_profile_request,
        accept: %w[application/json],
        content_type: %w[application/json multipart/form-data],
        auth: %w[cookieAuth tokenAuth])
    end
    ...
    def retrieve(id : Int32) : Response(NetboxClient::ModuleTypeProfile)
      @conn.request(NetboxClient::ModuleTypeProfile,
        method: :GET,
        path: "/api/dcim/module-type-profiles/{id}/".sub("{id}", NetboxClient.enc(id)),
        accept: %w[application/json],
    ...
    def update(id : Int32, module_type_profile_request : NetboxClient::ModuleTypeProfileRequest) : Response(NetboxClient::ModuleTypeProfile)
      @conn.request(NetboxClient::ModuleTypeProfile,
        method: :PUT,
        path: "/api/dcim/module-type-profiles/{id}/".sub("{id}", NetboxClient.enc(id)),
        body: module_type_profile_request,
