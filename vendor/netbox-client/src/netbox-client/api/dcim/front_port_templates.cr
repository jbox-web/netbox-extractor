...
module NetboxClient
  module Api
  class Dcim::FrontPortTemplates
    def initialize(@conn : Connection); end

    #  Delete a list of front port template objects.
    def bulk_destroy(front_port_template_request : Array(NetboxClient::FrontPortTemplateRequest)) : Response(Nil)
      @conn.request(Nil,
        method: :DELETE,
        path: "/api/dcim/front-port-templates/",
        body: front_port_template_request,
        accept: %w[],
    ...
    def bulk_partial_update(front_port_template_request : Array(NetboxClient::FrontPortTemplateRequest)) : Response(Array(NetboxClient::FrontPortTemplate))
      @conn.request(Array(NetboxClient::FrontPortTemplate),
        method: :PATCH,
        path: "/api/dcim/front-port-templates/",
        body: front_port_template_request,
    ...
    def bulk_update(front_port_template_request : Array(NetboxClient::FrontPortTemplateRequest)) : Response(Array(NetboxClient::FrontPortTemplate))
      @conn.request(Array(NetboxClient::FrontPortTemplate),
        method: :PUT,
        path: "/api/dcim/front-port-templates/",
        body: front_port_template_request,
    ...
    def create(dcim_front_port_templates_create_request : NetboxClient::DcimFrontPortTemplatesCreateRequest) : Response(NetboxClient::FrontPortTemplate)
      @conn.request(NetboxClient::FrontPortTemplate,
        method: :POST,
        path: "/api/dcim/front-port-templates/",
        body: dcim_front_port_templates_create_request,
        accept: %w[application/json],
        content_type: %w[application/json multipart/form-data],
        auth: %w[cookieAuth tokenAuth])
    end
    ...
    def retrieve(id : Int32) : Response(NetboxClient::FrontPortTemplate)
      @conn.request(NetboxClient::FrontPortTemplate,
        method: :GET,
        path: "/api/dcim/front-port-templates/{id}/".sub("{id}", NetboxClient.enc(id)),
        accept: %w[application/json],
    ...
    def update(id : Int32, writable_front_port_template_request : NetboxClient::WritableFrontPortTemplateRequest) : Response(NetboxClient::FrontPortTemplate)
      @conn.request(NetboxClient::FrontPortTemplate,
        method: :PUT,
        path: "/api/dcim/front-port-templates/{id}/".sub("{id}", NetboxClient.enc(id)),
        body: writable_front_port_template_request,
        accept: %w[application/json],
        content_type: %w[application/json multipart/form-data],
        auth: %w[cookieAuth tokenAuth])
    end
