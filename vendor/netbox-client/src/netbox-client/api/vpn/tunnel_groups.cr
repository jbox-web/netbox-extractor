...
module NetboxClient
  module Api
  class Vpn::TunnelGroups
    def initialize(@conn : Connection); end

    #  Delete a list of tunnel group objects.
    def bulk_destroy(tunnel_group_request : Array(NetboxClient::TunnelGroupRequest)) : Response(Nil)
      @conn.request(Nil,
        method: :DELETE,
        path: "/api/vpn/tunnel-groups/",
        body: tunnel_group_request,
        accept: %w[],
    ...
    def bulk_partial_update(tunnel_group_request : Array(NetboxClient::TunnelGroupRequest)) : Response(Array(NetboxClient::TunnelGroup))
      @conn.request(Array(NetboxClient::TunnelGroup),
        method: :PATCH,
        path: "/api/vpn/tunnel-groups/",
        body: tunnel_group_request,
    ...
    def bulk_update(tunnel_group_request : Array(NetboxClient::TunnelGroupRequest)) : Response(Array(NetboxClient::TunnelGroup))
      @conn.request(Array(NetboxClient::TunnelGroup),
        method: :PUT,
        path: "/api/vpn/tunnel-groups/",
        body: tunnel_group_request,
    ...
    def create(vpn_tunnel_groups_create_request : NetboxClient::VpnTunnelGroupsCreateRequest) : Response(NetboxClient::TunnelGroup)
      @conn.request(NetboxClient::TunnelGroup,
        method: :POST,
        path: "/api/vpn/tunnel-groups/",
        body: vpn_tunnel_groups_create_request,
        accept: %w[application/json],
        content_type: %w[application/json multipart/form-data],
        auth: %w[cookieAuth tokenAuth])
    end
    ...
    def partial_update(id : Int32, patched_tunnel_group_request : NetboxClient::PatchedTunnelGroupRequest? = nil) : Response(NetboxClient::TunnelGroup)
      @conn.request(NetboxClient::TunnelGroup,
        method: :PATCH,
        path: "/api/vpn/tunnel-groups/{id}/".sub("{id}", NetboxClient.enc(id)),
        body: patched_tunnel_group_request,
        accept: %w[application/json],
        content_type: %w[application/json multipart/form-data],
        auth: %w[cookieAuth tokenAuth])
    end
    ...
    def retrieve(id : Int32) : Response(NetboxClient::TunnelGroup)
      @conn.request(NetboxClient::TunnelGroup,
        method: :GET,
        path: "/api/vpn/tunnel-groups/{id}/".sub("{id}", NetboxClient.enc(id)),
        accept: %w[application/json],
    ...
    def update(id : Int32, tunnel_group_request : NetboxClient::TunnelGroupRequest) : Response(NetboxClient::TunnelGroup)
      @conn.request(NetboxClient::TunnelGroup,
        method: :PUT,
        path: "/api/vpn/tunnel-groups/{id}/".sub("{id}", NetboxClient.enc(id)),
        body: tunnel_group_request,
