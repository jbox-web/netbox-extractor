...
module NetboxClient
  ...
  class Vpn::L2vpns
    ...
    def bulk_destroy(l2_vpn_request : Array(NetboxClient::L2VPNRequest)) : Response(Nil)
      @conn.request(Nil,
        method: :DELETE,
        path: "/api/vpn/l2vpns/",
        body: l2_vpn_request,
    ...
    def bulk_partial_update(l2_vpn_request : Array(NetboxClient::L2VPNRequest)) : Response(Array(NetboxClient::L2VPN))
      @conn.request(Array(NetboxClient::L2VPN),
        method: :PATCH,
        path: "/api/vpn/l2vpns/",
        body: l2_vpn_request,
    ...
    def bulk_update(l2_vpn_request : Array(NetboxClient::L2VPNRequest)) : Response(Array(NetboxClient::L2VPN))
      @conn.request(Array(NetboxClient::L2VPN),
        method: :PUT,
        path: "/api/vpn/l2vpns/",
        body: l2_vpn_request,
    ...
    def create(vpn_l2vpns_create_request : NetboxClient::VpnL2vpnsCreateRequest) : Response(NetboxClient::L2VPN)
      @conn.request(NetboxClient::L2VPN,
        method: :POST,
        path: "/api/vpn/l2vpns/",
        body: vpn_l2vpns_create_request,
        accept: %w[application/json],
        content_type: %w[application/json multipart/form-data],
        auth: %w[cookieAuth tokenAuth])
    end
    ...
    #  Get a L2VPN object.
    def retrieve(id : Int32) : Response(NetboxClient::L2VPN)
      @conn.request(NetboxClient::L2VPN,
        method: :GET,
        path: "/api/vpn/l2vpns/{id}/".sub("{id}", NetboxClient.enc(id)),
        accept: %w[application/json],
    ...
    #  Put a L2VPN object.
    def update(id : Int32, writable_l2_vpn_request : NetboxClient::WritableL2VPNRequest) : Response(NetboxClient::L2VPN)
      @conn.request(NetboxClient::L2VPN,
        method: :PUT,
        path: "/api/vpn/l2vpns/{id}/".sub("{id}", NetboxClient.enc(id)),
        body: writable_l2_vpn_request,
        accept: %w[application/json],
        content_type: %w[application/json multipart/form-data],
        auth: %w[cookieAuth tokenAuth])
    end
