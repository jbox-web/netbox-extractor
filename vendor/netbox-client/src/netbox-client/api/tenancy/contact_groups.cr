...
module NetboxClient
  module Api
  class Tenancy::ContactGroups
    def initialize(@conn : Connection); end

    #  Delete a list of contact group objects.
    def bulk_destroy(contact_group_request : Array(NetboxClient::ContactGroupRequest)) : Response(Nil)
      @conn.request(Nil,
        method: :DELETE,
        path: "/api/tenancy/contact-groups/",
        body: contact_group_request,
        accept: %w[],
    ...
    def bulk_partial_update(contact_group_request : Array(NetboxClient::ContactGroupRequest)) : Response(Array(NetboxClient::ContactGroup))
      @conn.request(Array(NetboxClient::ContactGroup),
        method: :PATCH,
        path: "/api/tenancy/contact-groups/",
        body: contact_group_request,
    ...
    def bulk_update(contact_group_request : Array(NetboxClient::ContactGroupRequest)) : Response(Array(NetboxClient::ContactGroup))
      @conn.request(Array(NetboxClient::ContactGroup),
        method: :PUT,
        path: "/api/tenancy/contact-groups/",
        body: contact_group_request,
    ...
    def create(tenancy_contact_groups_create_request : NetboxClient::TenancyContactGroupsCreateRequest) : Response(NetboxClient::ContactGroup)
      @conn.request(NetboxClient::ContactGroup,
        method: :POST,
        path: "/api/tenancy/contact-groups/",
        body: tenancy_contact_groups_create_request,
        accept: %w[application/json],
        content_type: %w[application/json multipart/form-data],
        auth: %w[cookieAuth tokenAuth])
    end
    ...
    def retrieve(id : Int32) : Response(NetboxClient::ContactGroup)
      @conn.request(NetboxClient::ContactGroup,
        method: :GET,
        path: "/api/tenancy/contact-groups/{id}/".sub("{id}", NetboxClient.enc(id)),
        accept: %w[application/json],
    ...
    def update(id : Int32, writable_contact_group_request : NetboxClient::WritableContactGroupRequest) : Response(NetboxClient::ContactGroup)
      @conn.request(NetboxClient::ContactGroup,
        method: :PUT,
        path: "/api/tenancy/contact-groups/{id}/".sub("{id}", NetboxClient.enc(id)),
        body: writable_contact_group_request,
        accept: %w[application/json],
        content_type: %w[application/json multipart/form-data],
        auth: %w[cookieAuth tokenAuth])
    end
