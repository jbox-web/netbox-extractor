...
module NetboxClient
  module Api
  class Circuits::Providers
    def initialize(@conn : Connection); end

    #  Delete a list of provider objects.
    def bulk_destroy(provider_request : Array(NetboxClient::ProviderRequest)) : Response(Nil)
      @conn.request(Nil,
        method: :DELETE,
    ...
    def bulk_partial_update(provider_request : Array(NetboxClient::ProviderRequest)) : Response(Array(NetboxClient::Provider))
      @conn.request(Array(NetboxClient::Provider),
        method: :PATCH,
        path: "/api/circuits/providers/",
        body: provider_request,
    ...
    def bulk_update(provider_request : Array(NetboxClient::ProviderRequest)) : Response(Array(NetboxClient::Provider))
      @conn.request(Array(NetboxClient::Provider),
        method: :PUT,
        path: "/api/circuits/providers/",
        body: provider_request,
    ...
    def create(circuits_providers_create_request : NetboxClient::CircuitsProvidersCreateRequest) : Response(NetboxClient::Provider)
      @conn.request(NetboxClient::Provider,
        method: :POST,
        path: "/api/circuits/providers/",
        body: circuits_providers_create_request,
        accept: %w[application/json],
        content_type: %w[application/json multipart/form-data],
        auth: %w[cookieAuth tokenAuth])
    end
    ...
    def partial_update(id : Int32, patched_provider_request : NetboxClient::PatchedProviderRequest? = nil) : Response(NetboxClient::Provider)
      @conn.request(NetboxClient::Provider,
        method: :PATCH,
        path: "/api/circuits/providers/{id}/".sub("{id}", NetboxClient.enc(id)),
        body: patched_provider_request,
        accept: %w[application/json],
        content_type: %w[application/json multipart/form-data],
        auth: %w[cookieAuth tokenAuth])
    end
    ...
    def retrieve(id : Int32) : Response(NetboxClient::Provider)
      @conn.request(NetboxClient::Provider,
        method: :GET,
        path: "/api/circuits/providers/{id}/".sub("{id}", NetboxClient.enc(id)),
        accept: %w[application/json],
    ...
    def update(id : Int32, provider_request : NetboxClient::ProviderRequest) : Response(NetboxClient::Provider)
      @conn.request(NetboxClient::Provider,
        method: :PUT,
        path: "/api/circuits/providers/{id}/".sub("{id}", NetboxClient.enc(id)),
        body: provider_request,
