...
module NetboxClient
  module Api
  class Circuits::CircuitTypes
    def initialize(@conn : Connection); end

    #  Delete a list of circuit type objects.
    def bulk_destroy(circuit_type_request : Array(NetboxClient::CircuitTypeRequest)) : Response(Nil)
      @conn.request(Nil,
        method: :DELETE,
        path: "/api/circuits/circuit-types/",
        body: circuit_type_request,
        accept: %w[],
    ...
    def bulk_partial_update(circuit_type_request : Array(NetboxClient::CircuitTypeRequest)) : Response(Array(NetboxClient::CircuitType))
      @conn.request(Array(NetboxClient::CircuitType),
        method: :PATCH,
        path: "/api/circuits/circuit-types/",
        body: circuit_type_request,
    ...
    def bulk_update(circuit_type_request : Array(NetboxClient::CircuitTypeRequest)) : Response(Array(NetboxClient::CircuitType))
      @conn.request(Array(NetboxClient::CircuitType),
        method: :PUT,
        path: "/api/circuits/circuit-types/",
        body: circuit_type_request,
    ...
    def create(circuits_circuit_types_create_request : NetboxClient::CircuitsCircuitTypesCreateRequest) : Response(NetboxClient::CircuitType)
      @conn.request(NetboxClient::CircuitType,
        method: :POST,
        path: "/api/circuits/circuit-types/",
        body: circuits_circuit_types_create_request,
        accept: %w[application/json],
        content_type: %w[application/json multipart/form-data],
        auth: %w[cookieAuth tokenAuth])
    end
    ...
    def partial_update(id : Int32, patched_circuit_type_request : NetboxClient::PatchedCircuitTypeRequest? = nil) : Response(NetboxClient::CircuitType)
      @conn.request(NetboxClient::CircuitType,
        method: :PATCH,
        path: "/api/circuits/circuit-types/{id}/".sub("{id}", NetboxClient.enc(id)),
        body: patched_circuit_type_request,
        accept: %w[application/json],
        content_type: %w[application/json multipart/form-data],
        auth: %w[cookieAuth tokenAuth])
    end
    ...
    def retrieve(id : Int32) : Response(NetboxClient::CircuitType)
      @conn.request(NetboxClient::CircuitType,
        method: :GET,
        path: "/api/circuits/circuit-types/{id}/".sub("{id}", NetboxClient.enc(id)),
        accept: %w[application/json],
    ...
    def update(id : Int32, circuit_type_request : NetboxClient::CircuitTypeRequest) : Response(NetboxClient::CircuitType)
      @conn.request(NetboxClient::CircuitType,
        method: :PUT,
        path: "/api/circuits/circuit-types/{id}/".sub("{id}", NetboxClient.enc(id)),
        body: circuit_type_request,
