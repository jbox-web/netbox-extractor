...
module NetboxClient
  module Api
  class Circuits::CircuitGroups
    def initialize(@conn : Connection); end

    #  Delete a list of circuit group objects.
    def bulk_destroy(circuit_group_request : Array(NetboxClient::CircuitGroupRequest)) : Response(Nil)
      @conn.request(Nil,
        method: :DELETE,
        path: "/api/circuits/circuit-groups/",
        body: circuit_group_request,
        accept: %w[],
    ...
    def bulk_partial_update(circuit_group_request : Array(NetboxClient::CircuitGroupRequest)) : Response(Array(NetboxClient::CircuitGroup))
      @conn.request(Array(NetboxClient::CircuitGroup),
        method: :PATCH,
        path: "/api/circuits/circuit-groups/",
        body: circuit_group_request,
    ...
    def bulk_update(circuit_group_request : Array(NetboxClient::CircuitGroupRequest)) : Response(Array(NetboxClient::CircuitGroup))
      @conn.request(Array(NetboxClient::CircuitGroup),
        method: :PUT,
        path: "/api/circuits/circuit-groups/",
        body: circuit_group_request,
    ...
    def create(circuits_circuit_groups_create_request : NetboxClient::CircuitsCircuitGroupsCreateRequest) : Response(NetboxClient::CircuitGroup)
      @conn.request(NetboxClient::CircuitGroup,
        method: :POST,
        path: "/api/circuits/circuit-groups/",
        body: circuits_circuit_groups_create_request,
        accept: %w[application/json],
        content_type: %w[application/json multipart/form-data],
        auth: %w[cookieAuth tokenAuth])
    end
    ...
    def partial_update(id : Int32, patched_circuit_group_request : NetboxClient::PatchedCircuitGroupRequest? = nil) : Response(NetboxClient::CircuitGroup)
      @conn.request(NetboxClient::CircuitGroup,
        method: :PATCH,
        path: "/api/circuits/circuit-groups/{id}/".sub("{id}", NetboxClient.enc(id)),
        body: patched_circuit_group_request,
        accept: %w[application/json],
        content_type: %w[application/json multipart/form-data],
        auth: %w[cookieAuth tokenAuth])
    end
    ...
    def retrieve(id : Int32) : Response(NetboxClient::CircuitGroup)
      @conn.request(NetboxClient::CircuitGroup,
        method: :GET,
        path: "/api/circuits/circuit-groups/{id}/".sub("{id}", NetboxClient.enc(id)),
        accept: %w[application/json],
    ...
    def update(id : Int32, circuit_group_request : NetboxClient::CircuitGroupRequest) : Response(NetboxClient::CircuitGroup)
      @conn.request(NetboxClient::CircuitGroup,
        method: :PUT,
        path: "/api/circuits/circuit-groups/{id}/".sub("{id}", NetboxClient.enc(id)),
        body: circuit_group_request,
