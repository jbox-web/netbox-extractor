...
module NetboxClient
  module Api
  class Circuits::VirtualCircuitTypes
    def initialize(@conn : Connection); end

    #  Delete a list of virtual circuit type objects.
    def bulk_destroy(virtual_circuit_type_request : Array(NetboxClient::VirtualCircuitTypeRequest)) : Response(Nil)
      @conn.request(Nil,
        method: :DELETE,
        path: "/api/circuits/virtual-circuit-types/",
        body: virtual_circuit_type_request,
        accept: %w[],
    ...
    def bulk_partial_update(virtual_circuit_type_request : Array(NetboxClient::VirtualCircuitTypeRequest)) : Response(Array(NetboxClient::VirtualCircuitType))
      @conn.request(Array(NetboxClient::VirtualCircuitType),
        method: :PATCH,
        path: "/api/circuits/virtual-circuit-types/",
        body: virtual_circuit_type_request,
    ...
    def bulk_update(virtual_circuit_type_request : Array(NetboxClient::VirtualCircuitTypeRequest)) : Response(Array(NetboxClient::VirtualCircuitType))
      @conn.request(Array(NetboxClient::VirtualCircuitType),
        method: :PUT,
        path: "/api/circuits/virtual-circuit-types/",
        body: virtual_circuit_type_request,
    ...
    def create(circuits_virtual_circuit_types_create_request : NetboxClient::CircuitsVirtualCircuitTypesCreateRequest) : Response(NetboxClient::VirtualCircuitType)
      @conn.request(NetboxClient::VirtualCircuitType,
        method: :POST,
        path: "/api/circuits/virtual-circuit-types/",
        body: circuits_virtual_circuit_types_create_request,
        accept: %w[application/json],
        content_type: %w[application/json multipart/form-data],
        auth: %w[cookieAuth tokenAuth])
    end
    ...
    def partial_update(id : Int32, patched_virtual_circuit_type_request : NetboxClient::PatchedVirtualCircuitTypeRequest? = nil) : Response(NetboxClient::VirtualCircuitType)
      @conn.request(NetboxClient::VirtualCircuitType,
        method: :PATCH,
        path: "/api/circuits/virtual-circuit-types/{id}/".sub("{id}", NetboxClient.enc(id)),
        body: patched_virtual_circuit_type_request,
        accept: %w[application/json],
        content_type: %w[application/json multipart/form-data],
        auth: %w[cookieAuth tokenAuth])
    end
    ...
    def retrieve(id : Int32) : Response(NetboxClient::VirtualCircuitType)
      @conn.request(NetboxClient::VirtualCircuitType,
        method: :GET,
        path: "/api/circuits/virtual-circuit-types/{id}/".sub("{id}", NetboxClient.enc(id)),
        accept: %w[application/json],
    ...
    def update(id : Int32, virtual_circuit_type_request : NetboxClient::VirtualCircuitTypeRequest) : Response(NetboxClient::VirtualCircuitType)
      @conn.request(NetboxClient::VirtualCircuitType,
        method: :PUT,
        path: "/api/circuits/virtual-circuit-types/{id}/".sub("{id}", NetboxClient.enc(id)),
        body: virtual_circuit_type_request,
